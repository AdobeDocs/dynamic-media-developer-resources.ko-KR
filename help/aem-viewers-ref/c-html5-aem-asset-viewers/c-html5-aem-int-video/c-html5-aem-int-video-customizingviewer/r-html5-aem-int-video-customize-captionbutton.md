...
28 x 28픽셀이 되는 자막 단추를 설정하려면 다음을 수행합니다. 단추는 맨 위에서 4픽셀, 컨트롤 막대의 오른쪽 가장자리에서 68픽셀 떨어진 위치에 배치해야 합니다. 또한 선택되거나 선택되지 않을 때 4개의 서로 다른 단추 상태 각각에 대해 다른 이미지를 표시해야 합니다.
