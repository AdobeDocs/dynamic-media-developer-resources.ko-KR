...
<table id="table_04100BB8ABD84EF68B0A7CE3AD946414"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> 날짜 값</span> </span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> </td> 
   <td colname="col3"> <p> 메타데이터 서버에 대한 대/소문자 구분을 설정합니다. 에 사용됨 <span class="codeph"> searchAssetsByMeta</span> 호출합니다. </p> <p>다음을 참조하십시오 <a href="../../operations/c-operations-intro/c-methods/r-search-assets-by-metadata.md#reference-609ec73944a34ce49b152389fbb40414" format="dita" scope="local"> searchAssetsByMeta</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
