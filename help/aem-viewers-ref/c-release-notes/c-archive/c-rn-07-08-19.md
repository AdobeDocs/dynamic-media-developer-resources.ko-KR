...
## 5.13.1 {#section-f55c5ff7f6d0406c8739de4981dd7195}의 새로운 기능 및 개선 사항

* Adobe Launch Dynamic Media 뷰어 확장 통합에 대한 지원을 추가했습니다.
* Video360Viewer용 Oculus Browser에서 VR 작업 모드에 대한 지원을 추가했습니다.
* 클라이언트 코드가 eCatalogViewer 및 eCatalogSearchViewer에서 이미지 맵 활성화에 응답할 수 있도록 허용하는 `RolloverKeyEvent.HREF_ACTIVATED` 이벤트를 추가했습니다.

## 5.13.1 {#section-50e7ea1e01dd4e1fa9c8b3e00eb002b4} 버그 수정
