...
<table id="table_896DFF34A68A403DB93A6D597461A573"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>{ <span class="codeph"> } </span>} 새 자산 ID, 명시적 이미지 세트 또는 프레임 특정 이미지 제공 수정자가 포함된 명시적 이미지 세트, 선택적 글로벌 이미지 제공 수정자("?" 뒤에 추가). </p> <p> IR(이미지 렌더링) 또는 UGC(사용자 생성 컨텐츠)를 사용하는 이미지는 이 뷰어에서 지원되지 않습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
