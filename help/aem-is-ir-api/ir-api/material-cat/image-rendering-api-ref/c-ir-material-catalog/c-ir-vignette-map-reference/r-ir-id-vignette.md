---
description: 비네팅 식별자입니다. 서버가 비네팅 맵 파일의 레코드를 조회하는 인덱스 키 값입니다.
...
비네팅 식별자입니다. 서버가 비네팅 맵 파일의 레코드를 조회하는 인덱스 키 값입니다.

일반적으로 SKU 번호와 같은 짧고 고유한 식별자입니다. 파일 경로와 유사할 수 있는 보다 복잡한 문자열일 수도 있습니다.

## 속성 {#section-267bbf34677e4401abbaf6fdce52191b}

텍스트 문자열입니다. 필수. 비네팅 맵 테이블의 기본 인덱스 키입니다. 각 `vignette::Id` 값은 테이블 내에서 고유해야 하며 &#39;,&#39; 문자를 포함하지 않아야 합니다.
