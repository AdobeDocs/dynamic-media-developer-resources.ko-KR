...
<table id="table_7B5DD9303EF44ADD847B13FFEAD135D9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 이전 단추 </span> </p> </td> 
   <td colname="col2"> <p> <span class="codeph"> s7sdk.common.PanLeftButton </span> </p> </td> 
  </tr> 
 </tbody> 
</table>

SDK API를 사용하여 작업하는 경우 [Viewer SDK 네임스페이스](../../../c-html5-aem-asset-viewers/c-html5-aem-carousel/c-html5-aem-carousel-namespace.md)에 설명된 대로 올바른 정규화된 SDK 네임스페이스를 사용해야 합니다.
