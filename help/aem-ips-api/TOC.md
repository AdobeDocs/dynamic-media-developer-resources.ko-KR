...
+ 작업 메서드 {#operation-methods}
   ...
   + 작업 매개 변수 {#operation-parameters}
      ...
      + [getAllCompany](operations/c-operations-intro/c-methods/r-get-all-companies.md)
...
+ 데이터 유형 {#data-types}
   ...
   + [ExcludeMozineArray](types/c-data-types/r-exclude-byproduct-array.md)
   ...
   + [작업 오류](types/c-data-types/r-operation-fault.md)
...
+ 문자열 상수 {#sting-constants}
   ...
   + [자동 자르기 모퉁이](string-constants/c-string-constants/r-auto-crop-corner.md)
   ...
   + [속성 세트 유형](string-constants/c-string-constants/r-property-set-types.md)
