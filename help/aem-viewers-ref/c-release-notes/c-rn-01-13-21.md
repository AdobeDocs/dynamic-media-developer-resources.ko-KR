...
* SDK 버전을 3.10으로 업데이트하여 레거시 모바일 HTML5 뷰어의 XSS 문제를 수정했습니다. Dynamic Media에서 사용하는 새로운 기본 제공 HTML5 뷰어는 이 XSS 문제의 영향을 받지 않았으므로 업데이트되지 않았습니다.
...
* 터치 장치의 견본 지원 뷰어에서 `swatchoverlay` 수정자 동작이 수정되었습니다.
