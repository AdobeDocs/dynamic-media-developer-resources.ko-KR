...
<table id="simpletable_998CF426296945FEA48D19E33B71A17E"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>브라우저 포맷 변환 기능-JPEG 또는 PNG 이미지를 더 작은 브라우저 특정 파일 포맷으로 변환할지( <span class="codeph"> true </span>) 또는 해제( <span class="codeph"> false </span>)할지 여부를 지정합니다. </p> </td> 
 </tr> 
</table>
