...
<table id="table_9CB1F668E036422E8CE4E0BBA42EC44C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>작업을 제출한 사용자에게 처리합니다. </p> <p> <p>참고: 시스템에서 지정한 사용자에게 이메일을 보냅니다. <span class="codeph"> 사용자 핸들</span>. If <span class="codeph"> 사용자 핸들</span> 이 제공되지 않으면 작업을 제출한 사람이 이메일을 받습니다. </p> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> 아니요 </td> 
   <td colname="col4"> <p>작업 로그 세부 정보 및 이메일 현지화에 사용되는 로케일. </p> <p>로케일이 다음으로 지정됨 <span class="codeph"> &lt;language_code&gt;</span> 및 <span class="codeph"> [&lt;country_code&gt;]</span>여기서 언어 코드는 ISO-639에 지정된 소문자 두 자리 코드이고 선택적 국가 코드는 ISO-3166에 지정된 대문자 두 자리 코드입니다. 예를 들어 영어(미국)에 대한 로케일 문자열은 en-US입니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> 아니요 </td> 
   <td colname="col4"> <p>작업을 실행할 시기를 결정합니다. </p> <p> 일 수 있음 <span class="codeph"> cron</span> 반복으로 작업을 실행하는 문자열입니다. </p> <p>일정은 항상 서버의 현지 시간대를 기준으로 합니다. 사용자 지정 일정 형식에 대해서는 IPS 설명서를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> 아니요 </td> 
   <td colname="col4"> <p>이전에 업로드한 파일을 내보냅니다. </p> <p>다음을 참조하십시오 <a href="../../../types/c-data-types/r-exportjob.md#reference-1ce423f7b2d54507b90b67233c588665" format="dita" scope="local"> ExportJob</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> 아니요 </td> 
   <td colname="col4"> <p>비디오 게시 작업에 대한 세부 정보. </p> <p>다음을 참조하십시오 <a href="../../../types/c-data-types/r-video-publish-job.md#reference-e99e60d38fe94a07914eefcd7beef2e0" format="dita" scope="local"> VideoPublishJob</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> upload디렉터리 작업</span> </span> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> 아니요 </td> 
   <td colname="col4"> <p>자동화된 집합 스크립트를 사용하여 자산 목록을 집합으로 처리합니다. </p> <p>다음을 참조하십시오 <a href="../../../types/c-data-types/r-automated-set-generation-job.md#reference-ab0b3c5408eb41b98c49898b2197cf5a" format="dita" scope="local"> AutomatedSetGenerationJob</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
이 코드 샘플은 게시 작업을 제공하는 이미지를 IPS에 제출하고 작업 핸들을 반환합니다. 요청에서 작업 유형을 하나만 선택하십시오. 이유 `userHandle` 이(가) 생략되면 작업을 제출한 사용자에게 이메일 알림이 전송됩니다. 다음 이유로 이 샘플 작업이 즉시 실행됩니다. `execTime` 및 `execSchedule` 이(가) 생략되었습니다.
...
다음 중 최대 하나를 지정할 수 있습니다. `execTime` 및 `execSchedule`. 둘 다 전달되지 않으면 작업이 즉시 실행됩니다. 다음 중 하나만 사용할 수 있습니다.
