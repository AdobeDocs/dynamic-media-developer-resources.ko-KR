  ...
  <tr> 
   ...
   <td colname="col2"> <p>이미지 맵의 모양을 지정합니다. </p> <p> 
     <ul id="ul_DDA49C152718486E853213E6FC2182B2"> 
      ...
      <li id="li_F8832681CDD6456E9147A37C99BAFFED"> <p> <span class="codeph"> 영역 </span>은(는) 이미지 맵 영역을 렌더링합니다. 데스크톱에서는 롤오버 시 표시되고 터치 장치에서는 항상 표시됩니다. </p> </li> 
      <li id="li_9F7DD686E8104AEB944505363F433C0F"> <p> 데스크톱 시스템에서 <span class="codeph"> 자동 </span>, 이미지 맵 영역이 롤오버 시 표시되고 터치 장치에서 맵 아이콘이 항상 표시됩니다. </p> </li> 
