---
description: 기본적으로 소셜 공유 도구는 왼쪽 위 모퉁이에 표시됩니다. 사용자가 단추를 클릭하거나 탭할 때 확장되는 버튼과 패널로 구성되며 개별 공유 도구가 포함되어 있습니다.
seo-description: 기본적으로 소셜 공유 도구는 왼쪽 위 모퉁이에 표시됩니다. 사용자가 단추를 클릭하거나 탭할 때 확장되는 버튼과 패널로 구성되며 개별 공유 도구가 포함되어 있습니다.
seo-title: 소셜 공유
...
기본적으로 소셜 공유 도구는 왼쪽 위 모퉁이에 표시됩니다. 사용자가 단추를 클릭하거나 탭할 때 확장되는 버튼과 패널로 구성되며 개별 공유 도구가 포함되어 있습니다.
