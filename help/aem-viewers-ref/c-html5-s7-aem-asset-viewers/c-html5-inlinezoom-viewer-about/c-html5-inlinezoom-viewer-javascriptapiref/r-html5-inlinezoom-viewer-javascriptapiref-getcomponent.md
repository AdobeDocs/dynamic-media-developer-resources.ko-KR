...
SDK API를 사용할 때는 다음에 설명된 대로 정규화된 SDK 네임스페이스를 올바르게 사용해야 합니다. [Viewer SDK](../../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-namespace.md#concept-5af3b472b320496d87735ea612edda80).
