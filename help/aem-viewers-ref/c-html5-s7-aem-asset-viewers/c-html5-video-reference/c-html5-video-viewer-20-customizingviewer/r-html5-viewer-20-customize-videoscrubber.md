...
비디오 스크러버 도구 설명을 현지화할 수 있습니다. 자세한 [내용은 사용자 인터페이스 요소의](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad) 현지화를 참조하십시오.
...
>[!NOTE]
>
>이 버튼은 `state` 속성 선택기를 모두 지원합니다. 이 선택기는 다른 단추 상태에 다른 스킨을 적용하는 데 사용할 수 있습니다. 특히, `selected='default'` 기본 비디오 장 마커 상태에 해당하며, 마우스 위나 터치 제스처로 비디오 장 마커를 활성화할 `selected='over'` 때 사용됩니다.
