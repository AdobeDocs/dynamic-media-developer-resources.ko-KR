...
## 5.14.1의 새로운 기능 및 개선 사항 {#section-f55c5ff7f6d0406c8739de4981dd7195}

* 3D 미리 보기 및 전달용 DimensionalViewer.
* 포함된 모드에서 실행할 때 SmartCropVideoViewer에서 스마트 비디오 자르기가 개선되었습니다.
* FlyoutViewer, ZoomVerticalViewer 및 MixedMediaViewer에 대한 고해상도 화면에 대한 지원을 추가했습니다(인라인 확대/축소를 사용할 때).
