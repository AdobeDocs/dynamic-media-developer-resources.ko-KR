---
title: 확대/축소 재설정 단추
description: 이 버튼을 선택하면 기본 보기의 이미지가 재설정됩니다. 이 단추는 데스크탑 시스템 및 태블릿의 기본 컨트롤 막대에 나타납니다. 휴대폰에서 이 단추는 이미지 상단 가운데 하단에 표시됩니다. 하지만 이미지가 재설정 상태일 때는 표시되지 않습니다. CSS를 사용하여 이 버튼의 크기를 조정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
...
이 버튼을 선택하면 기본 보기의 이미지가 재설정됩니다. 이 단추는 데스크탑 시스템 및 태블릿의 기본 컨트롤 막대에 나타납니다. 휴대폰에서 이 단추는 이미지 상단 가운데 하단에 표시됩니다. 하지만 이미지가 재설정 상태일 때는 표시되지 않습니다. CSS를 사용하여 이 버튼의 크기를 조정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
...
예 - 28 x 28픽셀이고 바탕 화면에 4픽셀이 배치되고 기본 컨트롤 막대의 오른쪽 가장자리에서 47픽셀이 배치된 확대/축소 재설정 단추를 설정하려면 그리고 마지막으로, 는 네 개의 서로 다른 버튼 상태에 대해 각각 다른 이미지를 표시합니다.
