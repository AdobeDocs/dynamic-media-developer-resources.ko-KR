---
description: 선택 오류 처리. 선택 가능한 개체의 마스크 영역 내에 지정된 픽셀 위치가 없으므로 sel= 명령이 실패할 경우 수행할 작업을 지정합니다.
seo-description: 선택 오류 처리. 선택 가능한 개체의 마스크 영역 내에 지정된 픽셀 위치가 없으므로 sel= 명령이 실패할 경우 수행할 작업을 지정합니다.
seo-title: OnFailSel
...
선택 오류 처리. 선택 가능한 개체의 마스크 영역 내에 지정된 픽셀 위치가 없으므로 sel= 명령이 실패할 경우 수행할 작업을 지정합니다.
...
정의되지 `default::OnFailSel` 않은 경우 상속됩니다.
