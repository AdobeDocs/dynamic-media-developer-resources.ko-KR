...
seo-description: 인라인 확대/축소 뷰어에 대한 JavaScript API 참조
...
뷰어에서 사용하는 뷰어 SDK 구성 요소에 대한 참조를 반환합니다. 웹 페이지에서는 이 방법을 사용하여 기본 뷰어의 동작을 확장하거나 사용자 지정할 수 있습니다. 이 메서드는 `initComplete` 뷰어 콜백을 실행한 후에만 호출하십시오.그렇지 않으면 뷰어 논리로 구성 요소를 아직 만들 수 없습니다.
...
SDK API를 사용하여 작업하는 경우 Viewer SDK에 설명된 대로 올바른 정규화된 SDK 네임스페이스를 사용해야 [합니다](../../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-namespace.md#concept-5af3b472b320496d87735ea612edda80).
