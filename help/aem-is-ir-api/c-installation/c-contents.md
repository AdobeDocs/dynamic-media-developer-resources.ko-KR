---
description: 설치 후 install_root의 폴더 계층 구조는 아래에 나열된 파일과 폴더를 포함합니다.
seo-description: 설치 후 install_root의 폴더 계층 구조는 아래에 나열된 파일과 폴더를 포함합니다.
seo-title: 목차
...
설치 후 install_root의 폴더 계층 구조는 아래에 나열된 파일과 폴더를 포함합니다.

>[!NOTE]
>
>추가 파일 및 폴더가 있으며 수정해서는 안 됩니다.
...
<table id="table_F9FE5E0622A54CCD88461078FD5EA3DC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>Linux용 라이센스 파일 폴더 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>이전 설치의 이미지 제공 구성 파일 백업. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>이미지 제공을 시작 및 중지할 스크립트입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>Photoshop 텍스트 레이어 변수 추출. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> 유효성 검사(.exe) </span> </p> </td> 
   <td colname="col4"> <p>이미지 제공 이미지 유효성 검사 유틸리티. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
   <td colname="col3"> <p> <span class="filepath"> Vntc (.exe) </span> </p> </td> 
   <td colname="col4"> <p>이미지 렌더링 비네팅, 캐비닛 및 창 덮기 변환기 유틸리티. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> cache/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>데이터 캐시 폴더;구성 가능한 구성 요소가 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>기본 HTTP 응답 캐시. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> catalog/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>IS 이미지 카탈로그 폴더;구성 가능한 구성 요소가 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p> <span class="codeph"> 서버가 작동하려면 Default.ini </span>가 필요합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>자세한 내용은 설명서를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>이미지 제공용 기본 프로필이 포함되어 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>이미지 제공 소스 데이터 폴더;수동으로 구성 파일을 편집합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> 로그/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>모든 PS 및 IS 로그 데이터는 이 폴더에 기록됩니다.수동으로 구성 파일을 편집합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>정적 컨텐츠 데이터 소스 폴더;수동으로 구성 파일을 편집합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>여기에서 Java 웹 애플리케이션을 배포합니다(is-docs, ir-docs 및 is-viewers 포함). </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="filepath"> BACKUP/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>이전 설치의 구성 파일 백업. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> catalog/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>이미지 렌더링 카탈로그 폴더;구성 가능한 구성 요소가 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="filepath"> default-profiles/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>이미지 렌더링에 대한 기본 프로필이 포함되어 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> 리소스/ </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>이미지 렌더링 소스 데이터 폴더;수동으로 구성 파일을 편집합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
