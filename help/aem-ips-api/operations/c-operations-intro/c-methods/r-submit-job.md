...
<table id="table_9CB1F668E036422E8CE4E0BBA42EC44C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>작업을 제출한 사용자에게 처리합니다. </p> <p> <p>참고: 시스템이 지정한 사용자에게 이메일을 보냅니다 <span class="codeph"> userHandle</span>. If <span class="codeph"> userHandle</span> 을 제공하지 않으면 작업을 제출한 사람이 이메일을 받습니다. </p> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> 아니요 </td> 
   <td colname="col4"> <p>작업 로그 세부 사항 및 전자 메일 지역화에 사용되는 로케일입니다. </p> <p>로켈은 로 지정됩니다. <span class="codeph"> &lt;language_code&gt;</span> 및 <span class="codeph"> [&lt;country_code&gt;]</span>: 언어 코드가 ISO-639에 따라 소문자, 두 문자 코드이고, 선택적 국가 코드는 ISO-3166에 따라 지정된 대소문자 두 문자 코드입니다. 예를 들어 영어(미국)의 로케일 문자열은 다음과 같습니다. 미국. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> 아니요 </td> 
   <td colname="col4"> <p>작업을 실행할 시기를 결정합니다. </p> <p> 다음 중 하나일 수 있습니다 <span class="codeph"> cron</span> 반복적으로 작업을 실행하는 문자열입니다. </p> <p>예약은 항상 서버의 로컬 시간대를 기준으로 합니다. 사용자 지정 일정 형식에 대해서는 IPS 설명서를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> 아니요 </td> 
   <td colname="col4"> <p>이전에 업로드한 파일을 내보냅니다. </p> <p>자세한 내용은 <a href="../../../types/c-data-types/r-exportjob.md#reference-1ce423f7b2d54507b90b67233c588665" format="dita" scope="local"> 내보내기 작업</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> 아니요 </td> 
   <td colname="col4"> <p>비디오 게시 작업에 대한 세부 사항입니다. </p> <p>자세한 내용은 <a href="../../../types/c-data-types/r-video-publish-job.md#reference-e99e60d38fe94a07914eefcd7beef2e0" format="dita" scope="local"> VideoPublishJob</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> 아니요 </td> 
   <td colname="col4"> <p>자동화된 세트 스크립트를 사용하여 자산 목록을 세트로 처리합니다. </p> <p>자세한 내용은 <a href="../../../types/c-data-types/r-automated-set-generation-job.md#reference-ab0b3c5408eb41b98c49898b2197cf5a" format="dita" scope="local"> AutomatedSetGenerationJob</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
이 코드 샘플은 이미지 제공 게시 작업을 IPS에 제출하고 작업 핸들을 반환합니다. 요청에서 작업 유형을 하나만 선택합니다. 왜냐면 `userHandle` 이 생략되면 작업을 제출한 사용자에게 이메일 알림이 전송됩니다. 이 샘플 작업은 `execTime` 및 `execSchedule` 생략되었습니다.
...
최대 하나 이상의 `execTime` 및 `execSchedule`. 이 두 개 모두 전달되지 않으면 작업이 즉시 실행됩니다. 다음 중 하나만 사용할 수 있습니다.
