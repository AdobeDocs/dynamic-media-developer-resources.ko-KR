---
description: 이 단추를 클릭하거나 탭하면 뷰어가 기본 보기와 축소판 간에 전환됩니다. 이 단추는 기본 컨트롤 막대에 표시됩니다. CSS를 사용하여 이 단추의 크기를 조정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
seo-description: 이 단추를 클릭하거나 탭하면 뷰어가 기본 보기와 축소판 간에 전환됩니다. 이 단추는 기본 컨트롤 막대에 표시됩니다. CSS를 사용하여 이 단추의 크기를 조정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
seo-title: 축소판 단추
...
이 단추를 클릭하거나 탭하면 뷰어가 기본 보기와 축소판 간에 전환됩니다. 이 단추는 기본 컨트롤 막대에 표시됩니다. CSS를 사용하여 이 단추의 크기를 조정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
...
>[!NOTE]
>
>이 단추는 `state` 및 `selected` 속성 선택기를 모두 지원합니다. 이 선택기는 다른 단추 상태에 다른 스킨을 적용하는 데 사용할 수 있습니다. 특히 축소판 모드가 활성 상태이고 기본 보기가 있는 기본 상태에 `selected='true'` `selected='false'` 해당하는 경우 뷰어 상태에 해당합니다.
...
예 - 28 x 28픽셀인 축소판 단추를 설정하고 기본 컨트롤 막대의 왼쪽 가장자리에서 4픽셀, 왼쪽 가장자리에서 5픽셀을 지정했으며 선택 여부를 선택할 때 각각 다른 4개의 단추 상태에 대해 다른 이미지를 표시합니다.
