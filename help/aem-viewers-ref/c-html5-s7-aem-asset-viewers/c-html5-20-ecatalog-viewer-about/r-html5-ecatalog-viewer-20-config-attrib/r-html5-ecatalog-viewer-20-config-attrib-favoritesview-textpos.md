...
<table id="table_2B109D2F91E64B5382B31921C3780FA5"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 썸네일 이미지를 기준으로 레이블을 그리는 위치를 지정합니다. 즉, 레이블은 썸네일을 기준으로 지정된 위치의 가운데에 배치됩니다. </p> <p><span class="codeph"> 도구 설명</span>을 지정하면 레이블 텍스트가 썸네일 이미지 위에 부동 도구 설명으로 표시됩니다. </p> <p><span class="codeph"> none</span>(으)로 설정하면 레이블 표시가 꺼집니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
