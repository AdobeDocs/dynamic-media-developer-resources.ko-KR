...
**예** - 포함 크기 레이블을 맨 위에 정렬하고 너비를 80픽셀로 설정하려면:
...
**예** - 28픽셀 너비와 회색 배경의 스크롤 막대 트랙을 설정하려면:
...
**예** - 28 x 45픽셀이고 위쪽과 아래쪽에 10픽셀 여백이 있으며 각 상태에 따라 다른 아트웍이 있는 스크롤 막대 썸을 설정하려면 다음을 수행합니다.
