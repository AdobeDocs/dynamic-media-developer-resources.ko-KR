---
description: 축소판 해상도 축소판 이미지의 개체 해상도를 지정합니다.
seo-description: 축소판 해상도 축소판 이미지의 개체 해상도를 지정합니다.
seo-title: ThumbRes
...
축소판 해상도 축소판 이미지의 개체 해상도를 지정합니다.

(인 경우에만 `catalog::ThumbType=3`사용).

## 속성 {#section-ee5cae086a3d4875805fa8a08756a586}

0보다 큰 실수 값. 와 단위가 같아야 `catalog::Resolution`합니다.
