...
이 XML 파일을 수정할 때는 유효한 XML 구문을 유지하기 위해 주의해야 합니다. 그렇지 않으면 이미지 서버를 시작하지 못할 수 있습니다.

변경 사항을 적용하려면 이 파일을 편집한 후 이미지 서버를 다시 시작하십시오. 아래 나열된 요소 값만 수정할 수 있습니다. Scene7 기술 지원 센터에서 권장하는 경우에만 이 파일의 다른 내용을 편집합니다.
