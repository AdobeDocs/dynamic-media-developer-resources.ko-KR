...
* 무효화 CDN 캐시 기능 모니터링. CDN 무효화 템플릿을 선택한 후( 참조) [일반 설정](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/setup/application-setup.html#general-settings)), 및 **[!UICONTROL CDN 무효화]** 요청이 이루어지면 이제 캐시가 지워지는 데 걸리는 시간을 예상하여 표시기가 나타납니다.
