...
그렇지 않으면 표준 HTTP 인코딩 규칙이 적용됩니다. HTTP 사양을 사용하려면 안전하지 않은 문자뿐만 아니라 `<return>` 및 `<tab>` 등의 모든 컨트롤 문자를 인코딩해야 합니다. 문자의 URL 인코딩은 &quot;%&quot; 심볼로 구성되며, 그 다음에 ISO-라틴 코드 포인트의 두 자리 16진수 표현(대/소문자 구분 안 함)이 사용됩니다. 안전하지 않은 문자 및 코드 포인트는 다음과 같습니다.
...
[난독화 요청](../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-syntax-and-features/r-request-obfuscation.md#reference-895f65d6796c43bb9bad21a676ed714d),  [HTTP/1.1 사양(RFC 2616)](http://www.w3.org/Protocols/rfc2616/rfc2616.html)
