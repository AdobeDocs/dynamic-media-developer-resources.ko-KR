---
title: 기본 뷰어 영역
description: 기본 보기 영역은 대화형 색상 견본이 차지하는 영역입니다. 크기가 지정되지 않은 경우 사용 가능한 장치 화면에 맞게 설정됩니다.
...
기본 보기 영역은 대화형 색상 견본이 차지하는 영역입니다. 크기가 지정되지 않은 경우 사용 가능한 장치 화면에 맞게 설정됩니다.
