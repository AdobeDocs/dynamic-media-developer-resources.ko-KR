---
description: IPS API 버전 4.4의 새로운 작업 방법 및 변경된 작업 방법에 대해 설명합니다.
seo-description: IPS API 버전 4.4의 새로운 작업 방법 및 변경된 작업 방법에 대해 설명합니다.
...
IPS API 버전 4.4의 새로운 작업 방법 및 변경된 작업 방법에 대해 설명합니다.
