...
>[!NOTE]
>
>이 버튼은 `state`속성 선택기 `selected`및 `replay` 속성 선택기를 모두 지원합니다. 이 선택기는 다른 단추 상태에 다른 스킨을 적용하는 데 사용할 수 있습니다. 특히, `selected='true'` &quot;재생&quot; 상태에 해당하고 &quot;일시 중지&quot; 상태에 `selected='false'` 해당합니다.
>
