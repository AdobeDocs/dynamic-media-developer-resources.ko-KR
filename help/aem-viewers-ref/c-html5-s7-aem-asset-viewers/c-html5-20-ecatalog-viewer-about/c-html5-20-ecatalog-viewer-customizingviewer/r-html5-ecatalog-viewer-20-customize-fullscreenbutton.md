---
description: 사용자가 클릭하면 뷰어가 전체 화면 모드로 들어가거나 종료됩니다. 이 단추는 기본 컨트롤 막대에 표시됩니다. 뷰어가 팝업 모드에서 작동하고 시스템이 기본 전체 화면을 지원하지 않는 경우 이 단추가 표시되지 않습니다. CSS로 단추의 크기를 조정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
seo-description: 사용자가 클릭하면 뷰어가 전체 화면 모드로 들어가거나 종료됩니다. 이 단추는 기본 컨트롤 막대에 표시됩니다. 뷰어가 팝업 모드에서 작동하고 시스템이 기본 전체 화면을 지원하지 않는 경우 이 단추가 표시되지 않습니다. CSS로 단추의 크기를 조정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
seo-title: 전체 화면 단추
...
사용자가 클릭하면 뷰어가 전체 화면 모드로 들어가거나 종료됩니다. 이 단추는 기본 컨트롤 막대에 표시됩니다. 뷰어가 팝업 모드에서 작동하고 시스템이 기본 전체 화면을 지원하지 않는 경우 이 단추가 표시되지 않습니다. CSS로 단추의 크기를 조정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
...
예 - 28 x 28픽셀의 전체 화면 단추를 설정하고 기본 컨트롤 막대의 오른쪽 가장자리에서 4픽셀, 5픽셀의 위치를 지정하며 선택 또는 선택 시 각각 다른 4개의 단추 상태에 대해 다른 이미지를 표시합니다.
