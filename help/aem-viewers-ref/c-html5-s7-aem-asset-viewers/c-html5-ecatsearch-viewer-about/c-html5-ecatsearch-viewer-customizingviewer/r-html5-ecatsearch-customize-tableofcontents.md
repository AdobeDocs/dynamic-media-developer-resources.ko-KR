---
title: 목차
description: 목차는 기본 컨트롤 막대의 단추입니다. 활성화되면 페이지 인덱스 및 레이블 목록이 있는 드롭다운 패널이 나타납니다.
...
목차는 기본 컨트롤 막대의 단추입니다. 활성화되면 페이지 인덱스 및 레이블 목록이 있는 드롭다운 패널이 나타납니다.
...
예 - 맨 아래쪽에서 4픽셀, 기본 컨트롤 막대의 왼쪽에서 43픽셀로 위치하는 목차 단추를 설정합니다. 크기는 28 x 28 픽셀이며 4개의 서로 다른 단추 상태에 대해 다른 이미지가 표시됩니다.
