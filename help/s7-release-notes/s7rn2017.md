...
# [!DNL Dynamic Media] 릴리스 노트{#dynamic-media-release-notes}

Adobe에 대한 최신 릴리스 정보 [!DNL Dynamic Media] Classic — Adobe Experience Cloud의 Adobe Experience Manager 솔루션의 일부입니다.

## [!DNL Dynamic Media] 릴리스 노트 {#topic-1f5af440670a42f3bbb662eb86a196c6}
...
전체 문서를 보려면 다음을 참조하십시오.  [https://experienceleague.adobe.com/docs/dynamic-media-classic/using/intro/introduction.html#intro](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/intro/introduction.html#intro)
...
* 제거됨 **SPSAdmin 만들기** 보안상의 이유로 사용자 관리의 사용자 기능.
...
전체 문서를 보려면 다음을 참조하십시오. [뷰어 참조 안내서](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/homeviewers.html).
...
* 을 사용하여 왼쪽 및 오른쪽 페이지를 모두 지정하는 기능이 추가되었습니다. `initialframe` eCatalog 뷰어에서 모바일 장치의 세로 모드에 있는 매개 변수입니다.
...
* HTML5 비디오
   ...
   * HTML 페이지 호스팅이 외부 서버에서 제공되는 경우 비디오 캡션에는 회사 규칙 세트가 필요합니다( [!DNL Dynamic Media] server). 도움이 필요하면 Adobe 지원 센터에 문의하십시오.
