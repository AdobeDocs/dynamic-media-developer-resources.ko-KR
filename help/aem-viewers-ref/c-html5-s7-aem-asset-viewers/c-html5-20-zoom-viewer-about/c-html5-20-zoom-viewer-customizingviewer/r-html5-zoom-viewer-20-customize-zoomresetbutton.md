...
이 단추를 선택하거나 탭하면 기본 보기에서 이미지가 재설정됩니다. CSS를 사용하여 이 단추의 크기를 지정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
...
예 - 32 x 32픽셀인 확대/축소 재설정 단추를 설정하고 뷰어 상단 및 오른쪽 가장자리에서 6픽셀을 배치합니다. 마지막으로, 에서는 네 개의 서로 다른 단추 상태에 대해 다른 이미지를 표시합니다.
