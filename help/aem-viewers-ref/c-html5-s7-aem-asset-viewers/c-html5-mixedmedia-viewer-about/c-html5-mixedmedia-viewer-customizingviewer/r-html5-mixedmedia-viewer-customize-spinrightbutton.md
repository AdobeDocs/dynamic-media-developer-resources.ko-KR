...
이 버튼을 선택하면 기본 보기에서 이미지가 오른쪽으로 회전합니다. 이 버튼은 화면 부동산을 저장하기 위해 휴대폰에는 표시되지 않습니다. 또한 다차원 회전 집합을 사용하면 단추가 표시되지 않습니다. CSS를 사용하여 버튼의 크기를 조정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
