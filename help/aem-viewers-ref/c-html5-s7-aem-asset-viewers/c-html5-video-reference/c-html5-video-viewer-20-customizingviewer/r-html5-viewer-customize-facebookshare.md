---
description: Facebook 공유 도구는 소셜 공유 패널에 추가된 단추로 구성됩니다. 단추를 클릭하면 소셜 서비스에서 제공하는 공유 대화 상자로 리디렉션됩니다. 단추 위치는 Social 공유 도구로 완전히 관리됩니다.
seo-description: Facebook 공유 도구는 소셜 공유 패널에 추가된 단추로 구성됩니다. 단추를 클릭하면 소셜 서비스에서 제공하는 공유 대화 상자로 리디렉션됩니다. 단추 위치는 Social 공유 도구로 완전히 관리됩니다.
...
Facebook 공유 도구는 소셜 공유 패널에 추가된 단추로 구성됩니다. 단추를 클릭하면 소셜 서비스에서 제공하는 공유 대화 상자로 리디렉션됩니다. 단추 위치는 Social 공유 도구로 완전히 관리됩니다.
...
예 - 28 x 28픽셀의 Facebook 공유 단추를 설정하고 서로 다른 네 개의 단추 상태에 대해 다른 이미지를 표시하려면 다음을 수행합니다.
