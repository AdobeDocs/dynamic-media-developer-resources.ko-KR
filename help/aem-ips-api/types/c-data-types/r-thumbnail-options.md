...
<table id="table_C71FD0C995D94CE18994CDA2DC3460DF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>비디오 축소판에 사용할 프레임에 대한 시간(비디오 시작 이후 밀리초)을 설정합니다. 값의 범위는 0부터 비디오 끝까지 입니다. <p>참고: 시간을 잘못 지정하면 축소판용 비디오의 첫 번째 프레임이 사용됩니다. 자세한 내용은 <a href="../../types/c-data-types/r-media-options.md#reference-18618fc6803a4b6e994bbb48eba93b5b" format="dita" scope="local"> 미디어 옵션</a>. </p></p> </td> 
  </tr> 
 </tbody> 
</table>
