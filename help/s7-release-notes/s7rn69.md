...
* [Scene7 Publishing System 6.9 릴리스 특징](s7rn69.md#section-2ed72b7902be4509876d81f25b5632ce)
...
**Scene7 HTML Viewer 5 SDK 2.8.1에 대한 새로운 기능, 개선 사항 및 버그 수정**
...
* `zoomfactor` 수정자를 사용하여 HTML5 플라이아웃 뷰어에 대한 이미지 업스케일링을 제어하는 지원이 추가되었습니다.
...
* 포스터 이미지에 &quot;최대 크기&quot; 오류가 발생할 수 있습니다. 따라서 이미지 제공 Publish에 대한 제한 설정을 늘려야 합니다.
