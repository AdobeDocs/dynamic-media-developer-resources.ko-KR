---
description: Scene7 뷰어 5.8.2 릴리스 노트
...
## 5.8.2 {#section-50e7ea1e01dd4e1fa9c8b3e00eb002b4} 버그 수정

* 사용자가 `frametransition=turn`인 경우 마우스를 사용하여 페이지를 넘길 수 없습니다.
* `ImageMapEffect.mapTips=1` 터치 지원 장치에서 마우스 클릭이 스크립트 오류를 생성하는 중이었습니다.

## 5.8.1 {#section-f55c5ff7f6d0406c8739de4981dd7195}의 새로운 기능 및 개선 사항

* 기본 확대/축소, 플라이아웃, 혼합 미디어, 회전, 확대/축소, 비디오, 회전 메뉴, 대화형 이미지 및 대화형 비디오의 키보드 액세스 가능성.
* 비디오 뷰어, 혼합 미디어 뷰어 및 대화형 비디오 뷰어에 비디오 버퍼링 아이콘을 추가했습니다.
* `playback` 수정자의 `native` 값은 더 이상 사용되지 않습니다.대신 새 값 `progressive`을 사용하십시오.

* [!DNL Dynamic Media] 비디오에 대한 HTTPS 스트리밍 재생에 대한 지원을 추가했습니다.
...
## 5.8.1 {#section-867d7f16480f43d5ac0f6e3e4d77ad80} 버그 수정

* 사용자가 키보드 탭을 사용하여 비디오 컨트롤에 집중할 수 없었습니다.
* eCatalog 뷰어에서 단일/이중 페이지 레이아웃이 일부 장치에서 잘못 표시되었습니다.

## 5.8.2 {#section-af67bc1734844f31a89a09004b558c6e}에 대한 알려진 문제 및 제한 사항
