 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 포스터 이미지 모양을 제어하는 이미지 제공 수정자. URL에 지정된 경우 HTTP는 다음을 인코딩합니다. </p> <p> 
     ...
     </ul> </p> <p> 이 수정자는 Dynamic Media Classic 또는 Adobe Experience Manager, Dynamic Media에서 호스팅되는 비디오 컨텐츠에 대해 작동합니다. </p> <p>기본 포스터 이미지가 표시되지 않도록 하려면 <span class="codeph"> none</span> 을 포스터 이미지 값으로 지정합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
