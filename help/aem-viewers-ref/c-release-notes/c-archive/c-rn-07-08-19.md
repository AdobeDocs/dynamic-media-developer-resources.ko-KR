...
* Adobe Launch [!DNL Dynamic Media] 뷰어 확장과의 통합에 대한 지원을 추가했습니다.
* Video360Viewer용 Oculus 브라우저의 VR 작업 모드에 대한 지원을 추가했습니다.
* 클라이언트 코드가 eCatalogViewer 및 eCatalogSearchViewer에서 이미지 맵 활성화에 응답할 수 있도록 하는 `RolloverKeyEvent.HREF_ACTIVATED` 이벤트가 추가되었습니다.
