---
title: 닫기 단추
description: 이 단추를 선택하면 포함된 웹 페이지가 닫힙니다. 이 단추는 closebutton 매개 변수가 1로 설정된 경우에만 나타납니다. CSS를 사용하여 이 단추의 크기를 지정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
...
이 단추를 클릭하거나 탭하면 포함된 웹 페이지가 닫힙니다. 이 단추는 closebutton 매개 변수가 1로 설정된 경우에만 나타납니다. CSS를 사용하여 이 단추의 크기를 지정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
...
예 - 32 x 32픽셀이고 뷰어의 위쪽 및 오른쪽 가장자리로부터 6픽셀을 위치하는 닫기 단추를 설정하려면 다음을 수행하십시오. 4개의 서로 다른 단추 상태에 대해 다른 이미지를 표시해야 합니다.
