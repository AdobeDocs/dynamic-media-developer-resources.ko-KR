...
열거형. 가시 지표의 경우 0으로, 상대 색도계의 경우 1로, 채도의 경우 2로, 절대 색도계의 경우 3으로 설정합니다. 색상 프로필에 정의된 기본 렌더링 의도를 사용하려면 비워 두거나 다른 값으로 설정합니다.

## 기본값 {#section-9301e3b7d0184ec5bf54a6eb73a6d3c1}

정의되지 `default::IccRenderIntent`않은 경우 상속됩니다. 비어 있으면 &#39;상대 색도계&#39;가 적용됩니다.
