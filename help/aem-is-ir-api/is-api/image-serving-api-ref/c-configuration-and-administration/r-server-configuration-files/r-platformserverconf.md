---
description: 다음 포함 [!DNL Platform Server] 설정.
...
아래에 나열된 설정만 다음 위치에서 변경할 수 있습니다. [!DNL PlatformServer.conf]. 특정 설정이 없으면 파일의 아무 곳에나 추가할 수 있습니다. 각 설정의 인스턴스는 하나만 있을 수 있습니다.
