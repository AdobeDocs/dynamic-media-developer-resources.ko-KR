---
description: eCatalog Search Viewer는 스프레드별로 또는 페이지별로 전자 브로셔를 표시하는 카탈로그 뷰어입니다. eCatalog를 사용하면 사용자가 추가 사용자 인터페이스 요소 또는 전용 썸네일 모드를 사용하여 카탈로그를 탐색할 수 있습니다. 사용자는 모든 페이지를 확대하여 보다 자세한 내용을 확인할 수도 있습니다.
keywords: 반응형
...
eCatalog Search Viewer는 스프레드별로 또는 페이지별로 전자 브로셔를 표시하는 카탈로그 뷰어입니다. eCatalog를 사용하면 사용자가 추가 사용자 인터페이스 요소 또는 전용 썸네일 모드를 사용하여 카탈로그를 탐색할 수 있습니다. 사용자는 모든 페이지를 확대하여 보다 자세한 내용을 확인할 수도 있습니다.
...
eCatalog 검색 뷰어는 소셜 공유 도구를 지원합니다. 이 도구는 사용자가 클릭하거나 탭할 때 공유 도구 모음으로 확장되는 기본 컨트롤 막대에서 단추로 사용할 수 있습니다.
