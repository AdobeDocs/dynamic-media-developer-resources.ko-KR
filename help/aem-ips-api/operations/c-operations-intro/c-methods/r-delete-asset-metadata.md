---
description: 자산에 대한 메타데이터 값을 삭제합니다. 일괄 처리에서 값을 설정하기 위해 메타데이터 삭제 배열과 함께 작동합니다.
...
자산에 대한 메타데이터 값을 삭제합니다. 일괄 처리에서 값을 설정하기 위해 메타데이터 삭제 배열과 함께 작동합니다.
...
<table id="table_A4438E2FE5F245E5B73F46CD887BE70F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col4"> <p>폴더가 속한 회사의 핸들입니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>예 </p> </td> 
   <td colname="col4"> <p>자산에서 삭제할 메타데이터의 배열입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
