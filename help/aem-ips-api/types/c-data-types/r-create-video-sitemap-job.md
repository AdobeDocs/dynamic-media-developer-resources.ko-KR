...
<table id="table_7B459A9D55CE49A38D8A77CBD229033A"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"><span class="codeph"> true</span>(으)로 설정된 경우 사이트 맵을 생성합니다. <p><p>참고: 사이트 맵 생성 구성이 수동으로 설정되고 <span class="codeph"> forceUpdate</span>이 설정되지 않은 경우 사이트 맵이 생성되지 않습니다. </p></p></td> 
  </tr> 
 </tbody> 
</table>
