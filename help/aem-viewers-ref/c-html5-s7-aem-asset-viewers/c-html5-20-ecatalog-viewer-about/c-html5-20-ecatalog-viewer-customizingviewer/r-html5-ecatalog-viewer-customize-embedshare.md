...
예 - 64 x 34 [취소] 단추, 82 x 34 [모두 선택] 단추 및 각 단추 상태에 대해 다른 텍스트 색상 및 배경색이 있는 대화 상자 바닥글을 설정하려면 다음을 수행합니다.
...
예 - 드롭다운 단추를 28 x 28픽셀로 설정하고 각 상태에 대해 별도의 이미지를 만들려면 다음을 수행합니다.
...
예 - 스크롤 패널의 위쪽, 오른쪽 및 아래쪽에서 8픽셀 여백이 있고 폭이 28픽셀인 스크롤 막대를 설정하려면 다음을 수행합니다.
