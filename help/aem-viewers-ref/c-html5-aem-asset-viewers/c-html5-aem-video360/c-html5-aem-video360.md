...
팝업 작업 모드에서는 기본 HTML 페이지를 사용하는 것이 좋습니다. 이 이름을 [!DNL Video360Viewer.html]이라고 하며, 표준 IS-Viewers 배포의 [!DNL html5/] 하위 폴더 아래에 있습니다.
...
1. 뷰어 크기 설정
   ...
   HTML 페이지에서 직접 또는 나중에 Adobe Experience Manager Assets - On-Demand의 뷰어 사전 설정 레코드에 할당되거나 `style` 명령을 사용하여 명시적으로 전달된 사용자 지정 뷰어 CSS 파일에 크기를 지정할 수 있습니다.
