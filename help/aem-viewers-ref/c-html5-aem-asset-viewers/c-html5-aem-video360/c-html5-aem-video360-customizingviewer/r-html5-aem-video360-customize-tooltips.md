...
>[!NOTE]
>
>포함 웹 페이지 내에서 도구 설명 스타일을 사용자 지정하는 경우 모든 속성에 `!IMPORTANT` 규칙. 뷰어의 CSS 파일 내에서 도구 설명을 사용자 지정하는 경우에는 이 규칙이 필요하지 않습니다.

예 - 회색 테두리에 Arial®의 3픽셀 모퉁이 반경, 검은색 배경 및 흰색 텍스트가 있는 도구 설명을 설정하려면 11픽셀로 하십시오.
