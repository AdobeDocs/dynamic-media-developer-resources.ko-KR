---
title: 포커스 강조 표시
description: 포커스가 있는 뷰어 사용 인터페이스 요소 주위에 표시되는 입력 포커스 강조 표시는 CSS 클래스 선택기를 사용하여 제어됩니다.
...
포커스가 있는 뷰어 사용 인터페이스 요소 주위에 표시되는 입력 포커스 강조 표시는 CSS 클래스 선택기를 사용하여 제어됩니다.
