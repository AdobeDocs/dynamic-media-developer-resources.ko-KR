...
* 뷰어 배포를 단순화하기 위해 &quot;포함 코드&quot;를 추가했습니다.
  ...
  [!DNL Embed Code] 기능은 다음 자산 유형에 대해 [!DNL Preview: Viewer List]의 [!DNL URLs] 페이지 또는 [!DNL Detail View] 패널을 열 때 사용할 수 있습니다.
...
* 템플릿 세트 - Scene7 Publishing System 내에서 직접 Scene7 기본 템플릿의 다양한 변형을 게시하여 쉽게 관리할 수 있으며, 페이지 코드의 URL을 변경할 필요가 없습니다. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd968ca97bf00cf72-5eede3a113268dc80f5-8000.html).  -->
...
* Scene7 Web에서 Adobe Illustrator으로 만든 뒤틀기 왜곡을 동적으로 조작하여 온라인 인쇄 워크플로우에 적용합니다. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSef8d5860223939e2-d19776312a7267a200-8000.html#WSd968ca97bf00cf72-5eedd3a113268dc80f5-8000). -->
