---
description: 자산에 대한 메타데이터 값을 삭제합니다. 메타데이터 삭제 배열로 작업하여 묶음으로 값을 설정합니다.
seo-description: 자산에 대한 메타데이터 값을 삭제합니다. 메타데이터 삭제 배열로 작업하여 묶음으로 값을 설정합니다.
...
자산에 대한 메타데이터 값을 삭제합니다. 메타데이터 삭제 배열로 작업하여 묶음으로 값을 설정합니다.
