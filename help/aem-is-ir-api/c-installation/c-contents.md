---
description: 설치 후 install_root의 폴더 계층 구조는 아래 나열된 파일과 폴더를 포함합니다.
seo-description: 설치 후 install_root의 폴더 계층 구조는 아래 나열된 파일과 폴더를 포함합니다.
seo-title: 목차
...
설치 후 install_root의 폴더 계층 구조는 아래 나열된 파일과 폴더를 포함합니다.

>[!NOTE]
>
>추가 파일과 폴더가 있으며 수정할 수 없습니다.
...
<table id="table_F9FE5E0622A54CCD88461078FD5EA3DC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>이미지 렌더링 비네팅, 캐비닛 및 윈도우 커버 변환기 유틸리티. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> cache/  </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>데이터 캐시 폴더;구성 파일을 직접 편집하거나 설치할 때 구성할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>IS 이미지 카탈로그 폴더;구성 파일을 직접 편집하거나 설치할 때 구성할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p> <span class="codeph"> 서버 </span> 가 작동하려면 Default.ini가 필요합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> </td> 
   <td colname="col4"> <p>모든 PS 및 IS 로그 데이터가 이 폴더에 기록됩니다.수동으로 구성 파일을 편집합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>캐시 워밍업 유틸리티. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <span class="filepath"> webapps/  </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>여기에서 Java 웹 응용 프로그램(is-docs, ir-docs 및 is-viewer 포함)을 배포합니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="filepath"> catalog/  </span> </p> </td> 
   <td colname="col3"> </td> 
   <td colname="col4"> <p>이미지 렌더링 카탈로그 폴더;구성 파일을 직접 편집하거나 설치할 때 구성할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
