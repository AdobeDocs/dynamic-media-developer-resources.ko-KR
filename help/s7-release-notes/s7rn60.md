...
* 뷰어의 배포를 간소화하기 위해 &quot;포함 코드&quot;를 추가했습니다.
   ...
   [!DNL Embed Code] 기능은 다음 자산 유형에 대해 [!DNL Preview: Viewer List] 페이지 또는 [!DNL Detail View]의 [!DNL URLs] 패널을 열 때 사용할 수 있습니다.
...
* HTML5 SDK에 광범위한 새 뷰어 구성 요소가 추가되었습니다. (자세한 내용은 설치 프로그램에 포함된 HTML 5 SDK 추가 정보 를 참조하십시오.)
...
* 텍스트 및 그래픽의 현지화를 포함하여 뷰어에 대한 세계화 지원이 추가되었습니다. SDK 설치 프로그램에 포함된 Flash 또는 HTML5 뷰어 SDK 사용 안내서를 참조하십시오.
...
* Adobe Search &amp; Promote을 사용한 새로운 통합 워크플로우: Search &amp; Promote 캠페인 규칙에 따라 동적으로 어셈블된 Scene7 마케팅 배너를 검색 및 탐색 페이지에 쉽게 추가할 수 있습니다.

   Adobe Search &amp; Promote 설명서에서 &quot;배너 정보&quot;를 참조하십시오.
...
* 고급 프레임 관리를 포함하여 동적 배너 Flash 소스 컨텐츠(FLA)를 애니메이션 GIF 영화에 동적으로 컴파일합니다. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd968ca97bf00cf72-5eedd3a113268dc80f4-8000.html).  -->
...
* 메타데이터 서버는 자산의 모든 메타데이터 필드 하위 집합을 공개 서버에 노출하며 eCom 페이지 또는 서버에서 여기에서 요청할 수 있습니다. 이렇게 노출된 메타데이터는 자산 속성, UDF, XMP 및 메타데이터 스키마 속성의 혼합 세트일 수 있습니다. 메타데이터 서버는 메타데이터 검색, 이미지 유사 또는 둘 다 포함하는 다양한 검색 기능이 있는 웹 API를 제공합니다. 반환된 각 자산에 대해 메타데이터 속성 목록이 필요합니다. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WS1ffbb36e209a6fc9-44279087131d3ad5622-8000.html). -->
...
* 이제 메타데이터 설정이 관리 사용자 인터페이스에서 그룹화됩니다.
   ...
   이제 **[!UICONTROL 설정 > 응용 프로그램 설정]**&#x200B;에서 메타데이터 관련 설정 페이지가 [!DNL Metadata]라는 최상위 섹션으로 그룹화됩니다. 여기에는 메타데이터 보기, 메타데이터 사전 설정, 메타데이터 스키마 및 사용자 정의 필드에 대한 설정 페이지가 있습니다.
