---
description: 대화형 이미지 뷰어가 표시하는 특정 콘텐츠는 현지화가 적용됩니다. 여기에는 사용자 인터페이스 요소 도구 팁과 로드 시 플라이아웃 확대/축소 보기로 표시되는 정보 메시지가 포함됩니다.
...
대화형 이미지 뷰어가 표시하는 특정 콘텐츠는 현지화가 적용됩니다. 여기에는 사용자 인터페이스 요소 도구 팁과 로드 시 플라이아웃 확대/축소 보기로 표시되는 정보 메시지가 포함됩니다.
