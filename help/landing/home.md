...
* [뷰어 참조 안내서](/help/aem-viewers-ref/homeviewers.md)
...
* [이미지 제공/이미지 렌더링 API](/help/aem-is-ir-api/homeisir.md)
...
[!DNL Adobe Experience Cloud]에서 [!DNL Adobe Experience Manager] 솔루션의 Adobe [!DNL Dynamic Media] 클래식 부분에 대한 최신 릴리스 정보입니다.
