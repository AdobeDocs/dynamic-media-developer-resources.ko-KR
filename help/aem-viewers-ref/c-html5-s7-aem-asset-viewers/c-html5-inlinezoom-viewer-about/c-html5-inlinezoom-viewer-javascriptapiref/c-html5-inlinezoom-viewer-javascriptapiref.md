...
description: 인라인 확대/축소 뷰어의 기본 클래스는 FlyoutViewer입니다. s7viewers 네임스페이스에서 선언됩니다. 이 JavaScript API는 이 특정 클래스의 생성자, 메서드 및 콜백을 다룹니다.
...
인라인 확대/축소 뷰어의 기본 클래스는 FlyoutViewer입니다. s7viewers 네임스페이스에서 선언됩니다. 이 JavaScript API는 이 특정 클래스의 생성자, 메서드 및 콜백을 다룹니다.
...
* [플라이아웃 뷰어](r-html5-inlinezoom-viewer-javascriptapiref-inlinezoomviewer.md)
...
* [setHandler](r-html5-inlinezoom-viewer-javascriptapiref-sethandlers.md)
