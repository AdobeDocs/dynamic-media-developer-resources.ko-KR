...
seo-description: 즐겨찾기 추가 단추의 위치는 즐겨찾기 메뉴에서 완전히 관리됩니다.
...
[즐겨찾기 추가] 단추의 모양은 다음과 같은 CSS 클래스 선택기로 제어됩니다.
...
예 - 28 x 28픽셀인 즐겨찾기 추가 단추를 설정하고 선택 또는 선택하지 않을 때 4개의 서로 다른 단추 상태에 대해 다른 이미지를 표시하려면
