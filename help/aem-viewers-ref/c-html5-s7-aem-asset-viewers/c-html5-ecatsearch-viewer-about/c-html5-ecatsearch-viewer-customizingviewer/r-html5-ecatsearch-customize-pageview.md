...
<table id="table_77EBC9A77BF14CF4974F8F43C709A207"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 페이지 구분선의 폭입니다. 구분선을 완전히 숨기려면 <span class="codeph"> 0 </span>픽셀로 설정하십시오. </p> </td> 
  </tr> 
  <tr> 
...
>[!NOTE]
>
>`frametransition` 한정자가 데스크톱 시스템에서 `turn` 또는 `auto`(으)로 설정되면 페이지 분할기의 모양이 `pageturnstyle` 한정자로 제어되고 `.s7pagedivider` CSS 클래스가 무시됩니다.

기본 뷰어 영역 위에 사용자 지정 마우스 커서를 표시하도록 구성할 수 있습니다. 이 기능은 `.s7ecatalogsearchviewer .s7pageview` CSS 클래스에 적용되는 추가 특성 선택기로 제어됩니다.
