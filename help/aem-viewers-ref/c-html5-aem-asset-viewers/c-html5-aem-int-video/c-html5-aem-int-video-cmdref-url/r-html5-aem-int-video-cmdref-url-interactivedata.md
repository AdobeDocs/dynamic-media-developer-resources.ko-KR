...
대화형 데이터는 비디오 컨텐츠의 특정 시간 영역을 나중에 비디오 옆에 있는 대화형 견본에 표시되는 제품 데이터와 연결합니다. 비디오 재생 종료 시 표시되는 call-to-action 패널에도 연결됩니다. 또한 call-to-action 패널에 표시되는 대화형 비디오의 제목도 제공합니다.
