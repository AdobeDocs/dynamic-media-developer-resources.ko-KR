---
description: 다음 슬라이드 단추를 클릭하거나 탭하면 사용자가 회전판 세트의 다음 슬라이드로 이동합니다.
seo-description: 다음 슬라이드 단추를 클릭하거나 탭하면 사용자가 회전판 세트의 다음 슬라이드로 이동합니다.
seo-title: 다음 슬라이드
...
다음 슬라이드 단추를 클릭하거나 탭하면 사용자가 회전판 세트의 다음 슬라이드로 이동합니다.

<!--<a id="section_6C008EE11212461FA744F2540D38C295"></a>-->

이 단추는 터치 장치에 표시되지 않습니다. CSS를 사용하여 이 단추의 크기를 조정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
...
예 - 60 x 60픽셀인 이전 슬라이드 단추를 설정하고 오른쪽 뷰어 테두리에서 10픽셀을 배치하고 세로 가운데에 정렬하여 4개의 서로 다른 단추 상태 각각에 대해 다른 이미지를 표시하려면
