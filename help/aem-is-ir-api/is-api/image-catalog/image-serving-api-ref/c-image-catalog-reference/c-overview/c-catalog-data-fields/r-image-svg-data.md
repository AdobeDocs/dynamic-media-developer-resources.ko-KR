...
<table id="table_C070C676835F49918E1B3BBF81471B09"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Digimarc 포함에 대한 이미지별 정보입니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>응답 이미지에 대한 캐시 만료(TTL(Time-to-Live)). </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>포스트픽스 요청 수정자. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E07909B6C16F4D9686ADA381A4178E25"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>썸네일 해상도. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_B6A9A702F533494E85CEC1AD42EC728A"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이미지 집합 데이터입니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><span class="codeph"> <a href="/help/aem-is-ir-api/is-api/image-catalog/image-serving-api-ref/c-image-catalog-reference/c-image-svg-data-reference/c-image-data-reference/r-userdata-cat.md" type="reference" format="dita" scope="local"> 사용자 데이터</a></span> </p> </td> 
