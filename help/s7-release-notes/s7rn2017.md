...
Adobe에 대한 최신 릴리스 노트 [!DNL Dynamic Media] Classic — Adobe Experience Cloud에서 Adobe Experience Manager 솔루션의 일부입니다.
...
전체 설명서에 대해서는 [뷰어 참조 안내서](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/homeviewers.html).
...
* HTML5 비디오
   ...
   * 비디오 캡션을 사용하려면 외부 서버에서 HTML 페이지를 호스팅하는 경우 회사 규칙 세트가 필요합니다(가 아님) [!DNL Dynamic Media] server). 도움이 필요하면 Adobe 지원 센터에 문의하십시오.
