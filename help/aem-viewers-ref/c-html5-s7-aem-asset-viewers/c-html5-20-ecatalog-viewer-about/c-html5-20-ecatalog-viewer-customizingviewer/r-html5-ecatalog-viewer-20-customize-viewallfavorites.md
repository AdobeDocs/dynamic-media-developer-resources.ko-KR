---
description: 단추 위치는 즐겨찾기 메뉴에서 완전히 관리됩니다.
seo-description: 단추 위치는 즐겨찾기 메뉴에서 완전히 관리됩니다.
...
예 - 28 x 28픽셀인 모든 즐겨찾기 보기 단추를 설정하고 선택 또는 선택 안 했을 때 4개의 서로 다른 단추 상태에 대해 다른 이미지를 표시하려면
