...
[!DNL `[InfoPanelPopup.|<containerId>_infoPanelPopup.]template= *`템플릿`*`]
...
정보 서버 응답이 제품 이름을 변수 [!DNL `$1$` 및 제품 이미지 URL로 반환한다고 가정할 때 변수 [!DNL `$2$`.
