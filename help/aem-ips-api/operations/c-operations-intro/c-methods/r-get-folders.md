...
폴더를 사용하면 하위 폴더와 자산을 구성할 수 있습니다. 모든 폴더 및 자산 이름은 고유해야 합니다. 동일한 이름을 공유하는 폴더 및 에셋은 다른 폴더 계층 구조에 있더라도 네임스페이스 충돌이 발생합니다.
구문
...
| ` *`accessUserHandle`*` | `xsd:string` | 아니요 | 관리자가 특정 사용자를 가장하는 데 사용합니다. |
