...
>[!NOTE]
>
>아이콘 효과는 다음을 지원합니다 `media-type` 속성 선택기. 다른 장치에 다른 아이콘 효과를 적용하는 데 사용할 수 있습니다. 특히, `media-type='standard'` 마우스 입력이 정상적으로 사용되는 데스크톱 시스템에 해당합니다. `media-type='multitouch'` 터치 입력이 있는 장치에 해당합니다.
