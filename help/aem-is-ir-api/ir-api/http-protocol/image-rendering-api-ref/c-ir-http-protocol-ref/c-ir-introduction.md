...
<table id="simpletable_E96BA470B3CE4266A9E6ED0440A56C40"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p>[ <span class="varname"> 선택 사항 </span> ] </p> </td> 
...
** *`MSS`* ** 사양 세그먼트: 요청에서 두 선택 명령 사이의 자재 속성 세트입니다.

** *`vignette`* ** 렌더링에 사용하기 위해 Dynamic Media 이미지 작성에서 준비된 이미지를 저장합니다.
