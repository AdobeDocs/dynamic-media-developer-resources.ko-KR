...
시스템에서 비디오를 재생할 수 없을 때 표시되는 오류 메시지를 지역화할 수 있습니다. 자세한 [내용은 사용자 인터페이스 요소의](../../../c-html5-s7-aem-asset-viewers/c-html5-mixedmedia-viewer-about/c-html5-mixedmedia-viewer-localization.md#concept-16262b8096474d6c9c018c3e99110dd1) 현지화를 참조하십시오.
...
캡션은 비디오 플레이어 내부의 내부 컨테이너에 배치됩니다. 해당 컨테이너의 위치는 지원되는 WebVTT 배치 연산자에 의해 제어됩니다. 캡션 텍스트 자체는 해당 컨테이너 내에 있습니다.이 스타일은 다음과 같은 CSS 클래스 선택기로 제어됩니다.
...
예 - 반투명 검정 배경에서 캡션 텍스트를 14픽셀 밝은 회색 가리개로 설정하려면:
