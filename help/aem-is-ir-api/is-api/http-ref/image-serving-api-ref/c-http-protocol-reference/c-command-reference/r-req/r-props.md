---
description: 응답 데이터 속성입니다. 현재 요청을 이미지 요청인 것처럼 평가하지만(req=img), 이미지를 반환하지 않고 응답 이미지의 선택한 속성을 반환합니다.
...
응답 데이터 속성입니다. 현재 요청을 이미지 요청인 것처럼 평가하지만(req=img), 이미지를 반환하지 않고 응답 이미지의 선택한 속성을 반환합니다.
...
응답 구문 및 응답 MIME 유형에 대한 설명은 [속성](../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-response-data/c-properties/c-properties.md#concept-49c609fd6de942cab422ee412353c9d9)을 참조하십시오. HTTP 응답은 `attribute::NonImgExpiration` 을 기반으로 TTL로 캐시할 수 있습니다.
...
<table id="table_9665612ED7D24C07AAF75D953C0FEB36"> 
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> 정수 </p> </td> 
   <td> <p> 이미지 높이(픽셀 단위)에 회신 </p> </td> 
  </tr> 
  <tr> 
   <td valign="top"> <p> <span class="codeph"> image.iccEmbed  </span> </p> </td> 
   <td> <p> 부울 </p> </td> 
   <td> <p> ICC 프로파일이 회신 이미지에 포함된 경우 True입니다. ( <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-iccembed.md#reference-e3b774fb322046a2a6dde3a7bab5583e" type="reference" format="dita" scope="local"> IccEmbed= </a> </span> 참조). </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> image.iccProfile  </span> </p> </td> 
   <td> <p> 문자열 </p> </td> 
   <td> <p> 회신 이미지와 연관된 프로필의 이름/설명입니다. </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> enum </p> </td> 
   <td> <p> 응답 이미지에 알파 채널이 포함되어 있으면 1, 그렇지 않으면 0입니다. </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> image.pixType  </span> </p> </td> 
   <td> <p> 문자열 </p> </td> 
   <td> <p> 회신 이미지 유형은 <span class="codeph"> CMYK </span>, <span class="codeph"> RGB </span> 또는 <span class="codeph"> BW </span>일 수 있습니다(회색 음영 이미지의 경우). </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> image.pathEmbed  </span> </p> </td> 
   <td> <p> 부울 </p> </td> 
   <td> <p> 1 응답 이미지에 경로가 포함된 경우 1, 없는 경우 0. ( <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-pathembed.md#reference-9ccf0771d6634cf68c1c9c33cd428301" type="reference" format="dita" scope="local"> pathEmbed= </a> </span> 참조). </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> 문자열 </p> </td> 
   <td> <p> 회신 이미지의 MIME 유형입니다. ( <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-is-http-fmt.md#reference-cdf10043423b45ba9fe15157fb3ae37a" type="reference" format="dita" scope="local"> fmt= </a> </span> 참조) </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> 부울 </p> </td> 
   <td> <p> 1 응답 이미지에 xmp 데이터가 포함된 경우 1이고, 그렇지 않은 경우 0입니다. ( <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-xmpembed.md#reference-46ecf40a40a0442fa62de3a85dcb03e8" type="reference" format="dita" scope="local"> xmpEmbed= </a> </span> 참조). </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> image.version  </span> </p> </td> 
   <td> <p> 문자열 </p> </td> 
   <td> <p> 이미지 버전 식별자입니다. ( <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-id.md#reference-60661184deb3420998779724244fcfa0" type="reference" format="dita" scope="local"> id= </a> </span> 참조). </p> </td> 
  </tr> 
  <tr valign="top"> 
...
<table id="table_B66360C475CE495D9701AB526E758873"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 이중 </p> </td> 
   <td> <p> <span class="codeph"> 정적::만료 또 </span> 는 기본 라이브 시간입니다 </p> </td> 
  </tr> 
  <tr> 
