...
seo-description: 대화형 비디오 뷰어에 표시되는 특정 컨텐트는 로컬라이제이션을 따릅니다. 여기에는 사용자 인터페이스 요소 도구 설명 및 비디오를 재생할 수 없을 때 표시되는 오류 메시지가 포함됩니다.
...
대화형 비디오 뷰어에 표시되는 특정 컨텐트는 로컬라이제이션을 따릅니다. 여기에는 사용자 인터페이스 요소 도구 설명 및 비디오를 재생할 수 없을 때 표시되는 오류 메시지가 포함됩니다.
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 선택한 변경 가능 볼륨. </p> </td> 
  </tr> 
  <tr> 
