...
<table id="table_E78C924E34894CD7BE080C0D71500784"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p></span>에서  고해상도 미리 로드 을(를) <span class="uicontrol">(으)로 설정하면 구성된 프레임 범위가 고품질로 로드됩니다. 이 설정을 사용하면 대역폭 사용과 페이지 로드 시간이 크게 늘어날 수 있습니다. </p> </td>
  </tr>
 </tbody>
</table>
...
<table id="table_8B704CC077304CE2AC3E616D40B64CEF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 업로드 폴더 작업에서 임시 파일을 삭제하기 전에 마지막 파일 수정 이후 대기하는 시간(초)입니다. </p> <p><span class="codeph"> &lt;= 0 </span> 값을 사용하면 임시 파일을 삭제할 수 없습니다. 기본값은 3600입니다. </p> </td> 
  </tr> 
  <tr> 
...
* s7sdk.browser.device.version 이 다섯 번째 ™을 잘못 검색했던 문제를 해결했습니다.
