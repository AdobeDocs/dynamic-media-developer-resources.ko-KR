...
<table id="table_2B109D2F91E64B5382B31921C3780FA5"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 축소판 이미지를 기준으로 레이블이 그려지는 위치를 지정합니다. 즉, 레이블은 축소판을 기준으로 지정된 위치에 가운데에 표시됩니다. </p> <p>When <span class="codeph"> 도구 설명</span> 이 지정되면 축소판 이미지 위에 부동 도구 설명으로 레이블 텍스트가 표시됩니다. </p> <p>로 설정된 경우 <span class="codeph"> 없음</span>레이블 표시를 해제합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
