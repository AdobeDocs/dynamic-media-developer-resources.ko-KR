---
description: Adobe Experience Cloud의 Adobe Experience Manager 솔루션에 포함된 Adobe Dynamic Media Classic에 대한 최신 릴리스 노트입니다.
seo-description: Adobe Experience Cloud의 Adobe Experience Manager 솔루션에 포함된 Adobe Dynamic Media Classic에 대한 최신 릴리스 노트입니다.
...
Adobe Dynamic Media Classic에 대한 최신 릴리스 노트는 [!DNL Adobe Experience Manager] 솔루션에 포함되어 있습니다 [!DNL Adobe Experience Cloud].
...
* HTML5 비디오
   ...
   * HTML 페이지를 호스팅하는 것이 Dynamic Media 서버가 아닌 외부 서버에서 제공되는 경우 비디오 캡션을 사용하려면 회사 규칙 집합이 필요합니다. Adobe 지원 센터에 문의하십시오.
