---
description: 이 명령은 이미지, 텍스트 및 단색 레이어에 적용됩니다. 또한 일반적으로 합성 이미지와 간단하고 계층화되지 않은 이미지 요청에도 유용합니다.
...
이 명령은 이미지, 텍스트 및 단색 레이어에 적용됩니다. 또한 일반적으로 합성 이미지와 간단하고 계층화되지 않은 이미지 요청에도 유용합니다.
...
<table id="simpletable_996969D618C94BE8B81FAED512B5B7BA"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>레이어를 흐리게 합니다. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>레이어 밝기를 조정합니다. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>빨강, 녹색, 파랑을 독립적으로 조정합니다. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>레이어 데이터를 색상화합니다. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>대비를 조정합니다. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>모든 색상의 색조를 이동합니다. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>색상을 반전합니다. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>레이어에 노이즈를 추가합니다. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>색상 채도를 조정합니다. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>단순 선명하게 하기를 적용합니다. </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>레이어의 반전 클립 모양을 지정합니다. </p></td> 
 </tr> 
</table>
