...
<table id="table_57CEE262A33A4E898C6AFB30C93FD874"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> xsd:부울</span> </td> 
   <td colname="col3"> <p><span class="codeph"> assetSubTypeArray</span>가 전달될 때 하위 유형 없이 자산을 반환할지 여부를 지정하는 선택적 부울 플래그입니다. </p> <p>true면 지정된 하위 유형 중 하나가 있는 자산만 반환됩니다. </p> <p>false이면 하위 유형이 없는 자산도 반환됩니다. </p> <p>기본값은 false입니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3">지정: 
    <ul id="ul_D31B903FA8DA4CFFABAFABA3D8DA91EC"> 
     <li id="li_E4386C8260E64F0BAFE5BA57FF788E48"><span class="codeph"> </span> 휴지통 상태와 관계없이 자산을 반환할 수 있습니다. </li> 
     <li id="li_0B8933FE18C643828075EC8CE8C0223C"><span class="codeph"> </span> NotInTrashto가 'normal' 자산을 반환합니다. </li> 
     <li id="li_A1F46A0762FA4D4BA9F7247338238DC6"><span class="codeph"> </span> InTrashto가 휴지통에서 자산을 반환합니다. </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
