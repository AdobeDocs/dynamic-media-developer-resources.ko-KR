---
description: 색조 조정 레이어 또는 합성 이미지의 각 보이는 픽셀의 색조를 지정된 양만큼 이동합니다.
seo-description: 색조 조정 레이어 또는 합성 이미지의 각 보이는 픽셀의 색조를 지정된 양만큼 이동합니다.
seo-title: op_hue
...
색조 조정 레이어 또는 합성 이미지의 각 보이는 픽셀의 색조를 지정된 양만큼 이동합니다.
...
<table id="simpletable_7DC7ABA384664BDDAA65B8DEEF7859A8"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>색조 조정 도(-180...+180 int). </p></td> 
 </tr> 
</table>
