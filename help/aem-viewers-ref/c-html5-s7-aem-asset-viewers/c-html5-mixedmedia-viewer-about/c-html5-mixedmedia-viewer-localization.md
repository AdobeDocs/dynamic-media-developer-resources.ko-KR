---
description: 혼합 미디어 뷰어가 표시하는 특정 콘텐츠는 현지화가 적용됩니다. 여기에는 확대/축소 단추, 스핀 단추, 비디오 컨트롤, 닫기 단추 전체 화면 단추 및 견본 스크롤 단추가 포함됩니다.
...
혼합 미디어 뷰어가 표시하는 특정 콘텐츠는 현지화가 적용됩니다. 여기에는 확대/축소 단추, 스핀 단추, 비디오 컨트롤, 닫기 단추 전체 화면 단추 및 견본 스크롤 단추가 포함됩니다.
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="codeph"> 인라인 </span> 확대/축소 모드의 데스크톱 시스템. </p> </td> 
  </tr> 
  <tr> 
