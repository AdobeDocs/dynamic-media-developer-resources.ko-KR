...
예를 들어 `StatusEvent.NOTF_VIEW_READY` 이벤트 및 뷰어는 Experience Manager에서 제공하며 정규화된 이벤트 유형은 다음과 같습니다. `s7viewers.s7sdk.event.StatusEvent.NOTF_VIEW_READY`및 이벤트 리스너 코드는 다음과 유사합니다.
