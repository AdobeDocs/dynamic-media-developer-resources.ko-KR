...
예 - 패딩, 22x22픽셀 아이콘 및 굵은 16포인트 제목이 있는 대화 상자 헤더를 설정하려면 다음을 수행하십시오. 마지막으로 28x28픽셀 닫기 단추는 대화 상자 컨테이너의 맨 위에서 2픽셀, 맨 오른쪽에서 2픽셀을 배치합니다.
...
예 - 64 x 34 취소 단추와 96 x 34 인쇄로 보내기 단추가 있는 대화 상자 바닥글을 설정하려면 텍스트 색상과 배경색이 각 단추 상태에 따라 다릅니다.
...
예 - 자동으로 계산된 높이를 갖도록 기본 대화 상자 영역을 설정하고 10개의 픽셀 여백을 사용하며 흰색 배경을 사용합니다.
...
예 - 양쪽에 10픽셀 수직 패딩이 있고 맨 위에 10픽셀 여백이 있는 430픽셀 너비 회색 구분선을 설정하려면 다음을 수행하십시오.
