---
description: 이 명령은 이미지, 텍스트 및 단색 레이어에 적용됩니다. 대부분 복합 이미지와 단순하고 레이어가 없는 요청에 의미가 없습니다. 효과 레이어에는 적용되지 않습니다.
...
이 명령은 이미지, 텍스트 및 단색 레이어에 적용됩니다. 대부분 복합 이미지와 단순하고 레이어가 없는 요청에 의미가 없습니다. 효과 레이어에는 적용되지 않습니다.
...
<table id="simpletable_8A74E965537D4E8CB91E95AEAE9673E0"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>레이어 크기 제한을 지정합니다. </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>레이어 숨기기 </p></td> 
 </tr> 
</table>
