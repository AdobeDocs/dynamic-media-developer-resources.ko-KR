...
<table id="table_23B5CFC5C3F946F9AFDB6A83A1AAB7AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3">메타데이터 서버에 <span class="codeph">모두</span> 데이터를 다시 게시하려면 <i> True</i>(으)로 설정합니다. <p>참고: 데이터 양에 따라 몇 분에서 몇 시간 정도 소요될 수 있습니다. </p><p>새 메타데이터나 변경된 메타데이터만 게시하려면 이 매개 변수를 설정하지 마십시오. </p></td> 
  </tr> 
 </tbody> 
</table>
