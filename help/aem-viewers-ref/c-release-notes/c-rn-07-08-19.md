...
* Adobe Launch Dynamic Media Viewers 익스텐션과의 통합에 대한 지원이 추가되었습니다.
* Video360Viewer용 Oculus Browser에서 VR 작업 모드에 대한 지원이 추가되었습니다.
* 클라이언트 코드가 eCatalogViewer 및 eCatalogSearchViewer에서 이미지 맵 활성화에 반응하도록 허용하는 `RolloverKeyEvent.HREF_ACTIVATED` 이벤트를 추가했습니다.

## 5.13.1에 대한 버그 수정 {#section-50e7ea1e01dd4e1fa9c8b3e00eb002b4}

* 잘못된 긴 비디오 지속 시간이 표시되는 문제가 해결되었습니다.
