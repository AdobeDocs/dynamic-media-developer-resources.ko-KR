---
description: 특정 성능 또는 오류 임계값이 초과되면 이메일 경고를 보내도록 서버를 구성할 수 있습니다. 시스템은 서버에 배포된 모든 웹 애플리케이션을 종합적으로 모니터링합니다.
seo-description: 특정 성능 또는 오류 임계값이 초과되면 이메일 경고를 보내도록 서버를 구성할 수 있습니다. 시스템은 서버에 배포된 모든 웹 애플리케이션을 종합적으로 모니터링합니다.
seo-title: 서버 모니터링
...
특정 성능 또는 오류 임계값이 초과되면 이메일 경고를 보내도록 서버를 구성할 수 있습니다. 시스템은 서버에 배포된 모든 웹 애플리케이션을 종합적으로 모니터링합니다.

* [표준 경고](r-standard-alerts.md)
* [더미 공간 우선 순위 경고](c-heap-space-priority-alert.md)
