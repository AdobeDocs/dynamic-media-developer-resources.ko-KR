...
| 이름 | 유형 | 필수 | 설명 |
|---|---|---|---|
| ` *`fieldHandle`*` | `xsd:string` | 예 | 새 메타데이터 필드의 처리. |

## 예제 {#section-4441c26d1f41466ba972b43dd5189e89}

이 코드 샘플은 자산 유형 및 메타데이터 필드 유형 문자열 상수로 제한된 새 메타데이터 필드를 만듭니다. `fieldHandle` 요소에 올바른 필드 핸들 값이 있으면 메타데이터 값이 변경되고 요청에 지정한 것과 동일한 필드 핸들이 생성됩니다.
