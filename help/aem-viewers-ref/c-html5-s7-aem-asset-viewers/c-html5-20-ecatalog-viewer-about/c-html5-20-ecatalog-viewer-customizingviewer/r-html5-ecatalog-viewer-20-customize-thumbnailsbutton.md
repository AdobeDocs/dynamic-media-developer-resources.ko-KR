...
이 단추를 선택하거나 탭하면 기본 보기와 축소판 간의 뷰어가 토글됩니다. 이 단추는 주 컨트롤 모음에 나타납니다. CSS를 사용하여 이 단추의 크기를 지정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
...
예 - 28 x 28픽셀이고 아래쪽에서 4픽셀이고 기본 컨트롤 막대의 왼쪽 가장자리에서 5픽셀인 축소판 단추를 설정하려면 다음을 수행합니다. 마지막으로, 선택 여부에 따라 4개의 서로 다른 단추 상태에 대해 다른 이미지를 표시합니다.
