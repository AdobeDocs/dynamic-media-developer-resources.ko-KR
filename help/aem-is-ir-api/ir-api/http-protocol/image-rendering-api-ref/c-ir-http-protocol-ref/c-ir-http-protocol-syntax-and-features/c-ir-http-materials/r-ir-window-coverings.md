---
title: 창문 커버
description: 창문 덮개재로는 부드러운 창문 커버(커튼월, 장식, 카페 커튼)와 차양(차양 및 블라인드)가 모두 있다.
...
창문 덮개재로는 부드러운 창문 커버(커튼월, 장식, 카페 커튼)와 차양(차양 및 블라인드)가 모두 있다.

창 커버 재료는 *윈도우 커버 스타일 파일* ( [!DNL .vnw] 파일 확장자)를 포함하는 특수 데이터 파일로서, 윈도우가 적용되는 마스크, 조명, 레이아웃 및 텍스처 데이터를 포함합니다.
...
<table id="table_545865B054E84592BDAEDA57DBFAE9B3"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-src.md#reference-62c98abad22149d68d405ed6aaff8272" type="reference" format="dita" scope="local"> <span class="codeph"> src= </span> </a> </p> </td> 
   <td colname="col2"> <p>텍스처 이미지 파일(에 대한 두 번째 값) <span class="codeph"> src= </span>). </p> </td> 
   <td colname="col3"> <p>없음. </p> </td> 
  </tr> 
  <tr> 
