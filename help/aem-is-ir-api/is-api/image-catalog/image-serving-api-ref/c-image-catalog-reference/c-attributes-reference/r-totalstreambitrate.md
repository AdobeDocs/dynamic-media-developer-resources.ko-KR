---
description: 총 스트림 비트 전송률입니다. 비디오 에셋의 총 스트림 비트 전송률을 나타내는 긴 값입니다.
...
# 총 스트림 비트율{#totalstreambitrate}

총 스트림 비트 전송률입니다. 비디오 에셋의 총 스트림 비트 전송률을 나타내는 긴 값입니다.

사용한 사람 `req=set` 및 `req=mbrSet`비트 전송률 데이터를 내보내도록 요청합니다.
