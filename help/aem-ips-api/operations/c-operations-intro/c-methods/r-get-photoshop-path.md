---
description: 명명된 Photoshop 패스를 둘러싼 4각형의 좌표를 반환합니다.
seo-description: 명명된 Photoshop 패스를 둘러싼 4각형의 좌표를 반환합니다.
...
명명된 Photoshop 패스를 둘러싼 4각형의 좌표를 반환합니다.
...
| 이름 | 유형 | 필수 | 설명 |
|---|---|---|---|
| ` *`perspectiveQuad`*` | `types:PerspectiveQuad` | 예 | 경로를 기반으로 이미지 좌표를 반환합니다. PerspectiveQuad [를 참조하십시오](../../../types/c-data-types/r-perspective-quad.md#reference-3c1f780f9c264e5b870b1ade24566204). |
