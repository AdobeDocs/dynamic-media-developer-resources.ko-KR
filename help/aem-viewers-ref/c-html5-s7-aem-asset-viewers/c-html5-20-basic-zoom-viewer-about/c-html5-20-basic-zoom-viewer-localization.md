---
description: 기본 확대/축소 뷰어에 표시되는 특정 컨텐츠는 확대/축소 버튼 및 전체 화면 버튼 등 로컬라이제이션에 적용됩니다.
seo-description: 기본 확대/축소 뷰어에 표시되는 특정 컨텐츠는 확대/축소 버튼 및 전체 화면 버튼 등 로컬라이제이션에 적용됩니다.
...
기본 확대/축소 뷰어에 표시되는 특정 컨텐츠는 확대/축소 버튼 및 전체 화면 버튼 등 로컬라이제이션에 적용됩니다.
