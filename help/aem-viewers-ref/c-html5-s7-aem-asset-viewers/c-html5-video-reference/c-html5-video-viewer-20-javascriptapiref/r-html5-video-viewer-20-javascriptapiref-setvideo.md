...
새로운 외부 비디오 및 선택적 추가 비디오 데이터를 설정합니다. 전과 후에 언제든지 호출할 수 `init()`있습니다. 이후에 `init()`호출되면 뷰어는 런타임 시 비디오를 교체합니다.
...
<table id="table_896DFF34A68A403DB93A6D597461A573"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>새 비디오에 대한 절대 URL <span class="codeph"> ({}) </span>을 반환합니다. </p> </td> 
  </tr> 
  <tr> 
