...
<table id="table_441553CD34C94A58A9D7CBF772DEDDB6"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 견본이 보기에서 채워지는 방식을 지정합니다. </p> <p>왼쪽에서 오른쪽으로 채우기 순서를 설정하려면 <span class="codeph"> 왼쪽 </span>으로 설정합니다. </p> <p><span class="codeph"> 오른쪽 </span>으로 설정하면 보기가 오른쪽에서 왼쪽, 위에서 아래로 채워지도록 순서가 반전됩니다. </p> <p>로케일이 " <span class="codeph"> ja </span>";으로 설정되면 <span class="codeph"> auto </span>이(가) 올바른 모드를 적용합니다.그렇지 않으면 <span class="codeph"> left </span>가 사용됩니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
