...
예 - 패딩, 24 x 14픽셀 아이콘 및 굵은 16포인트 제목을 사용한 대화 상자 헤더를 설정하려면 다음을 수행하십시오. 그리고 28x28픽셀 닫기 단추, 상단에서 2픽셀, 대화 상자 컨테이너 오른쪽에서는 2픽셀을 위치했습니다.
...
예 - 텍스트 복사본을 430픽셀 너비로 설정하고 하단에 10픽셀 패딩을 설정하려면 다음을 수행합니다.
...
예 - 포함 코드 텍스트 주위에 픽셀 회색 테두리를 한 개 설정하려면 너비가 430픽셀이고 10픽셀 패딩이 있습니다.
...
포함 크기 레이블 및 드롭다운은 대화 상자의 하단에 위치하며 다음 CSS 클래스 선택기로 제어되는 컨테이너에 배치됩니다.
...
예 - 10픽셀의 패딩을 포함하도록 포함 크기 패널을 설정하려면 다음을 수행합니다.
...
예 - 사용자 지정 크기를 표시할 때 미리 정의된 항목을 표시할 때 포함 크기 콤보 상자의 너비를 300픽셀로 설정하려면 다음을 수행합니다.
...
단추 도구 설명은 현지화할 수 있습니다. 자세한 내용은 [사용자 인터페이스 요소의 로컬라이제이션](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 추가 정보.
