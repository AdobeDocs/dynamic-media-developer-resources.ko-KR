...
<table id="table_C58EF9963CB34179A9D6C9F0F6FF24F2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">가상 파일 이름을 반환합니다. 전체 가상 파일 경로가 <span class="codeph"> 폴더</span>+<span class="codeph"> fileName</span>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">자산 유형. 자세한 내용은 <a href="../../string-constants/c-string-constants/r-asset-types.md#reference-2fe75d230663419d88632d30f1144a10" format="dita" scope="local"> 자산 유형</a> 참조하십시오. </td> 
  </tr> 
  <tr> 
