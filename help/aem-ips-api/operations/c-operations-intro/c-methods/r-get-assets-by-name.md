...
<table id="table_CE7B503B0E074719A523B458DF3A7286"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> 아니요 </td> 
   <td colname="col4"> <p><span class="codeph"> true</span> 및 <span class="codeph"> assetSubTypeArray</span>이(가) 비어 있지 않으면 <span class="codeph"> assetSubTypeArray</span>에 하위 유형이 있는 자산만 반환됩니다. </p> <p><span class="codeph"> false</span>이면 정의된 하위 유형이 없는 자산이 포함됩니다. </p> <p>기본값은 <span class="codeph"> false</span>입니다. </p> </td> 
  </tr> 
  <tr> 
