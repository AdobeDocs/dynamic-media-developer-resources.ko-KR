...
이 단추를 클릭하거나 탭하면 포함된 웹 페이지가 닫힙니다. 이 단추는 closebutton 매개 변수가 1로 설정된 경우에만 나타납니다. 이 단추는 데스크톱 시스템에서 사용할 수 없습니다. CSS를 사용하여 이 단추의 크기를 지정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
...
예 - 56 x 56픽셀인 닫기 단추를 설정하고, 기본 컨트롤 막대의 위쪽 및 오른쪽 가장자리로부터 4픽셀을 지정하며, 네 개의 서로 다른 단추 상태 각각에 대해 다른 이미지를 표시합니다.
