---
description: 카탈로그 RootId를 제외한 모든 카탈로그 속성은 선택 사항입니다.
...
* [오류 이미지](r-errorimage.md)
* [오류 세부 정보](r-errordetail.md)
* [만료](r-expiration.md)
* [글꼴 맵 파일](r-fontmapfile.md)
* [전체 일치](r-fullmatch.md)
* [HttpAppleStreamingContext](r-httpapplestreamingcontext.md)
* [HttpFlashStreamingContext](r-httpflashstreamingcontext.md)
* [IccBlackPoint 보상](r-iccblackpointcompensation.md)
...
* [Icc 프로파일Rgb](r-iccprofilergb.md)
...
* [로케일 맵](r-localemap.md)
* [LocaleStrMap](r-localestrmap.md)
* [매크로 파일](r-macrofile.md)
* [MaxPix](r-maxpix.md)
...
* [리소스 모드](r-is-cat-resmode.md)
* [해상도](r-resolution.md)
* [RootId](r-rootid.md)
* [루트 경로](r-rootpath.md)
* [RootUrl](r-rooturl.md)
* [규칙 집합 파일](r-rulesetfile.md)
...
* [총 스트림 비트율](r-totalstreambitrate.md)
* [트러스트된 도메인](r-trusteddomains.md)
* [마지막 수정 날짜 사용](r-uselastmodified.md)
* [비디오 비트 전송률](r-videobitrate-cat.md)
* [비디오 크기](r-videosize-cat.md)
* [워터마크](r-watermark.md)
