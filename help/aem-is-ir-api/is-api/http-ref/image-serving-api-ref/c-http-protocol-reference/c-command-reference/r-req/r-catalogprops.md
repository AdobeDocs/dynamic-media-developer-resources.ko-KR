...
카탈로그 ID를 생략하여 기본 카탈로그 속성( [!DNL default.ini])을 검색합니다. The HTTP response is cacheable with the TTL based on `attribute::NonImgExpiration`.
...
<table id="table_DEC26CBF274945298BA81B5E2E2F331D"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> hex </p> </td> 
   <td> <p> <span class="codeph"> 속성::BkgColor</span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> 실제 </p> </td> 
   <td> <p> <span class="codeph"> 속성::DefaultExpiration</span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> int </p> </td> 
   <td> <p> <span class="codeph"> 속성::PrintResolution</span> </p> </td> 
  </tr> 
  <tr> 
   <td> <p> <span class="codeph"> catalog.publishInfo</span> </p> </td> 
   <td> <p> 문자열 </p> </td> 
   <td> <p> <span class="codeph"> 속성::PublishInfo</span> </p> </td> 
  </tr> 
  <tr> 
   <td> <p> <span class="codeph"> catalog.resMode</span> </p> </td> 
   <td> <p> enum </p> </td> 
   <td> <p> <span class="codeph"> 속성::ResMode</span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> hex </p> </td> 
   <td> <p> <span class="codeph"> 속성::ThumbBkgColor</span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> 실제 </p> </td> 
   <td> <p> <span class="codeph"> 속성::ThumbRes</span> </p> </td> 
  </tr> 
  <tr> 
   <td> <p> <span class="codeph"> catalog.thumbType</span> </p> </td> 
   <td> <p> enum </p> </td> 
   <td> <p> <span class="codeph"> 속성::ThumbType</span> </p> </td> 
  </tr> 
  <tr> 
   <td> <p> <span class="codeph"> catalog.thumb 파섹</span> </p> </td> 
   <td> <p> enum </p> </td> 
