---
description: 이 단추를 클릭하거나 탭하면 사용자가 카탈로그의 이전 페이지로 이동합니다. 이 단추는 주 제어 막대에 표시됩니다. 화면 공간을 저장하기 위해 이 단추가 휴대폰에 표시되지 않습니다. CSS를 사용하여 이 단추의 크기를 조정하고, 스킨을 지정하고 위치를 지정할 수 있습니다.
seo-description: 이 단추를 클릭하거나 탭하면 사용자가 카탈로그의 이전 페이지로 이동합니다. 이 단추는 주 제어 막대에 표시됩니다. 화면 공간을 저장하기 위해 이 단추가 휴대폰에 표시되지 않습니다. CSS를 사용하여 이 단추의 크기를 조정하고, 스킨을 지정하고 위치를 지정할 수 있습니다.
seo-title: 큰 이전 페이지 단추
...
이 단추를 클릭하거나 탭하면 사용자가 카탈로그의 이전 페이지로 이동합니다. 이 단추는 주 제어 막대에 표시됩니다. 화면 공간을 저장하기 위해 이 단추가 휴대폰에 표시되지 않습니다. CSS를 사용하여 이 단추의 크기를 조정하고, 스킨을 지정하고 위치를 지정할 수 있습니다.
...
예 - 왼쪽 뷰어 테두리에 수직으로 중앙에 고정되고 고정된 큰 56 x 56픽셀의 이전 페이지 단추를 설정하고 서로 다른 4개의 단추 상태 각각에 대해 다른 이미지를 표시하려면.
