...
`catalog::UserData`의 콘텐츠가 반환됩니다. &#39;text&#39; 형식을 지정하면 `??`에서 `catalog::UserData`의 모든 인스턴스가 줄 종결자로 대체되고 한 줄 종결자(CR/LF)가 끝에 추가됩니다. URL 경로가 유효한 카탈로그 항목으로 확인되지 않으면 응답은 한 줄 종결자로만 구성됩니다. &#39;xml&#39; 또는 &#39;json&#39; 형식이 요청되면 적절한 형식이 적용됩니다.
