---
description: CDN 무효화 요청에 제공된 URL 중 하나에 응답하는 메시지 배열.
seo-description: CDN 무효화 요청에 제공된 URL 중 하나에 응답하는 메시지 배열.
...
CDN 무효화 요청에 제공된 URL 중 하나에 응답하는 메시지 배열.
...
<table id="table_C8AEAC1759E144499557ECEBDAF740B9"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td> <p> CDN으로 인해 발생한 메시지 목록은 요청 무효화 목록입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
