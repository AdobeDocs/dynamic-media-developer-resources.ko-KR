---
description: 이 섹션의 정보를 사용하여 이미지 서버를 구성하고 관리하십시오.
...
# 구성 및 관리{#configuration-and-administration}

이 섹션의 정보를 사용하여 이미지 서버를 구성하고 관리하십시오.

* [서버 구성 파일](r-server-configuration-files/r-server-configuration-files.md)
