...
<table id="table_896DFF34A68A403DB93A6D597461A573"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>{<span class="codeph"> 문자열</span>} 뒤에 이미지 제공 수정자(선택 사항)가 추가된 새 에셋 id, 단일 또는 다차원 스핀 세트 <span class="codeph"> ?</span>. </p> <p> IR(이미지 렌더링) 또는 UGC(사용자 생성 컨텐츠)를 사용하는 이미지는 이 뷰어에서 지원되지 않습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
