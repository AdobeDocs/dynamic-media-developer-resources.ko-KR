...
seo-description: 인쇄 도구는 도구가 활성화될 때 표시되는 모달 대화 상자와 컨트롤 막대에 추가된 단추로 구성됩니다.
seo-title: 인쇄
...
인쇄 도구는 도구가 활성화될 때 표시되는 모달 대화 상자와 컨트롤 막대에 추가된 단추로 구성됩니다.

<!--<a id="section_061E550C1C1D4DB2BD663A898895B38C"></a>-->

인쇄 버튼의 모양은 다음과 같은 CSS 클래스 선택기로 제어됩니다.
...
예 - 28 x 28픽셀인 인쇄 단추를 설정하고 4개의 서로 다른 단추 상태에 대해 다른 이미지를 표시하려면
...
기본적으로 모달 대화 상자는 데스크톱 시스템의 화면에 중앙에 표시됩니다. 대화 상자의 위치와 크기는 구성 요소에 의해 관리됩니다. 대화 상자는 다음 CSS 클래스 선택기로 제어됩니다.
...
예 - 회색 배경이 되도록 대화 상자를 설정하는 방법은 다음과 같습니다.
...
예 - 패딩, 22 x 22픽셀 아이콘, 굵은 16포인트 제목, 28 x 28픽셀 닫기 단추 등으로 대화 상자 컨테이너 오른쪽의 2픽셀과 2픽셀의 대화 상자 머리글을 설정하려면 다음을 수행합니다.
...
예 - 각 단추 상태에 대해 텍스트 색상과 배경색이 다른 64 x 34 [취소] 단추 및 96 x 34[인쇄로 보내기] 단추와 함께 대화 상자 바닥글을 설정하려면 다음을 수행합니다.
...
예 - 자동으로 계산된 높이를 갖도록 기본 대화 상자 영역을 설정하려면 10픽셀 여백을 사용하고 흰색 배경을 사용합니다.
...
대화 상자 내용 블록의 크기는 다음과 같은 CSS 클래스 선택기로 제어됩니다.
...
예 - 컨텐츠 블록을 너비가 430픽셀이고 아래쪽에 패딩이 10픽셀인 것으로 설정하려면:
...
입력 컨트롤은 컨테이너에 들어 있으며 다음과 같은 CSS 클래스 선택기로 제어됩니다.
...
라디오 버튼 및 캡션 텍스트는 다음과 같은 CSS 클래스 선택기로 제어됩니다.
...
<table id="table_3B4D85C5A0254A17A34D57F84F8200F7"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 너비  </span> </p> </td> 
   <td colname="col2"> <p> 캡션이 있는 라디오 단추의 전체 폭입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> color  </span> </p> </td> 
...
<table id="table_BDD03247E594416D93CDF8604DCE937B"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 오른쪽 여백  </span> </p> </td> 
   <td colname="col2"> <p> 라디오 단추와 해당 캡션 사이의 간격입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>

인쇄 범위 선택을 위한 숫자 선택기는 다음과 같은 CSS 클래스 선택기로 제어됩니다
...
<table id="table_35413C16F6B840EBBEEA17890F2A0490"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 너비  </span> </p> </td> 
   <td colname="col2"> <p> 숫자 피커의 폭입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> margin  </span> </p> </td> 
   <td colname="col2"> <p> 숫자 피커 주위의 간격입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>

예 - 모든 라디오 단추를 검정 텍스트와 함께 150픽셀 너비, 10픽셀 간격 및 42픽셀 너비의 숫자 피커로 설정하려면:
...
페이지 범위 선택과 인쇄 레이아웃 섹션 간의 가로 구분선은 다음과 같은 CSS 클래스 선택기로 제어됩니다.
...
<table id="table_AB42F1DC92BB4946868F0A9FE86ABAA6"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 경계 </span> </p> </td> 
   <td colname="col2"> <p> 구분선 주위의 경계. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 패딩 </span> </p> </td> 
   <td colname="col2"> <p>내부 패딩. </p> </td> 
...
예 - 양면에 10픽셀 세로 패딩이 10픽셀인 430픽셀 너비 회색 구분선을 설정하고 맨 위에 10픽셀 여백을 설정하려면:
