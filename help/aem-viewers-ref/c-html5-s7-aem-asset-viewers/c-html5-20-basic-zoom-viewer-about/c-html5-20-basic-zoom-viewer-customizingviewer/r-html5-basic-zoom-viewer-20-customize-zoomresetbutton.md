---
title: 확대/축소 재설정 단추
description: 이 버튼을 선택하면 기본 보기의 이미지가 재설정됩니다. CSS를 사용하여 이 버튼의 크기를 조정하고, 스킨을 지정하고, 위치를 지정할 수 있습니다.
...
예 - 뷰어의 위쪽 및 오른쪽 가장자리에서 6픽셀 떨어진 위치에 32x32픽셀인 확대/축소 재설정 단추를 설정합니다. 4개의 서로 다른 버튼 상태에 대해 각각 다른 이미지를 표시해야 합니다.
