---
description: 혼합 미디어 뷰어에 표시되는 특정 컨텐츠는 현지화의 대상이 됩니다. 여기에는 확대/축소 단추, 회전 단추, 비디오 컨트롤, 닫기 단추 전체 화면 단추 및 견본 스크롤 단추가 포함됩니다.
seo-description: 혼합 미디어 뷰어에 표시되는 특정 컨텐츠는 현지화의 대상이 됩니다. 여기에는 확대/축소 단추, 회전 단추, 비디오 컨트롤, 닫기 단추 전체 화면 단추 및 견본 스크롤 단추가 포함됩니다.
...
혼합 미디어 뷰어에 표시되는 특정 컨텐츠는 현지화의 대상이 됩니다. 여기에는 확대/축소 단추, 회전 단추, 비디오 컨트롤, 닫기 단추 전체 화면 단추 및 견본 스크롤 단추가 포함됩니다.
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>데스크탑 시스템을 <span class="codeph"> 인라인 </span> 확대/축소 모드로 전환합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> FlyoutZoomView.TIP_BUBBLE_TAP </span> </p> </td> 
   <td colname="col2"> <p>장치를 <span class="codeph"> 인라인 </span> 확대/축소 모드로 터치합니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>선택한 닫기 캡션 단추 상태입니다. </p> </td> 
  </tr> 
  <tr> 
