...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>검색 결과가 반환되지 않았을 때 현지화된 메시지가 표시됩니다. </p> <p>이 기호는 다음 런타임 대체 토큰을 지원합니다. <span class="codeph"> $SEARCH_TEXT$ </span>. 이 구성 요소는 사용자가 입력한 검색 텍스트로 바뀝니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>검색이 성공적으로 완료되고 하나 이상의 결과가 반환되면 현지화된 메시지가 표시됩니다. </p> <p>이 기호는 다음과 같은 런타임 대체 토큰을 지원합니다. </p> <p> 
     <ul id="ul_30B76EAB921848069BE843A5F91F697A"> 
      ...
      <li id="li_A0FBF12344B04BF0B702A2B7473330A8"> <span class="codeph"> $HIT_COUNT$ </span> - 발견된 총 검색 히트 수입니다. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>전체 검색 패널에 대한 <span class="codeph"> Aria 레이블 </span> ARIA 특성의 값을 정의합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
