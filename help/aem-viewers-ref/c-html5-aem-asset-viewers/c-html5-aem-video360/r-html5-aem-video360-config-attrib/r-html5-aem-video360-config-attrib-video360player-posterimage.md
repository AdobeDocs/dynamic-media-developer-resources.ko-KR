...
<table id="table_C616483932C2482CA9794DDD7313FD7C"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 포스터 이미지 모양을 제어하는 이미지 제공 수정자입니다. URL 파섹 </p> <p> 
     ...
     </ul> </p> <p> 이 수정자는 Dynamic Media Classic 또는 AEM Dynamic Media에서 호스팅되는 비디오 컨텐츠에 대해 작동합니다. </p> <p>기본 포스터 이미지가 표시되지 않도록 하려면 <span class="codeph"> 없음을</span> 포스터 이미지 값으로 지정합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
