...
* URL이 있는 Dynamic Media 비디오를 게시하는 경우 `Video360Player.ssl`을(를) URL에 추가합니다.
...
* 포함 코드가 있는 Dynamic Media 비디오를 게시하는 경우 포함 코드 조각의 다른 뷰어 구성 매개 변수 목록에 `Video360Player.ssl`을(를) 추가합니다.
