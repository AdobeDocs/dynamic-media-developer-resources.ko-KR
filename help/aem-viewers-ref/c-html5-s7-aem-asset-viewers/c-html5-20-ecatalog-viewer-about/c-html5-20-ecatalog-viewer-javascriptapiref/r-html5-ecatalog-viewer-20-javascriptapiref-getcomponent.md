...
SDK API를 사용할 때는 다음에 설명된 대로 올바른 정규화된 SDK 네임스페이스를 사용해야 합니다 [Viewer SDK 네임스페이스](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-html5-viewer-sdk-namespace.md#concept-16ce67bfbdc64ffc8fc7ad174f208f05).

자세한 내용은 *뷰어 SDK API* 특정 구성 요소에 대한 자세한 내용은 설명서 를 참조하십시오.
