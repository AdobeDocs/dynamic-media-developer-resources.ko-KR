---
description: 혼합 미디어 뷰어는 즉시 사용 가능한 Adobe Analytics 추적을 지원합니다.
seo-description: 혼합 미디어 뷰어는 즉시 사용 가능한 Adobe Analytics 추적을 지원합니다.
...
혼합 미디어 뷰어는 즉시 사용 가능한 Adobe Analytics 추적을 지원합니다.

## 즉시 사용 가능한 추적 {#section-ba994f079d0343c8ae48adffaa3195a3}

혼합 미디어 뷰어는 즉시 사용 가능한 [!DNL Adobe Analytics] 추적을 지원합니다. 추적을 활성화하려면 적절한 회사 사전 설정 이름을 `config2` 매개 변수로 전달합니다.
