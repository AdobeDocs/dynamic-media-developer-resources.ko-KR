...
서버는 이 값을 와 결합하여 실제 비네팅 파일 경로를 `attribute::RootPath` 만듭니다. 절대 경로일 수도 있습니다.

## 속성 {#section-b3b295feac084b56bd8a153c04987153}

텍스트 문자열. 선택 사항입니다. 지정된 경우 올바른 상대 또는 절대 파일 경로여야 합니다. 비어 있으면 `vignette::Modifier` 명령을 `vignette=` 포함해야 합니다.
