...
* 이 릴리스에 따라 새로운 즉시 게시 기능이 점진적으로 롤아웃됩니다. 이 기능은 현재 &quot;게시용으로 표시&quot; 기능을 대체합니다. 일부 사용자는 다른 사용자보다 먼저 새 기능을 보게 됩니다. 롤아웃 기간이 거의 완료되면 SPS 설명서 및 UI 요소가 업데이트됩니다. 롤아웃이 시작되면 더 자세한 정보가 포함된 이메일을 받게 됩니다.
...
* 뷰어 배포를 단순화하기 위해 &quot;포함 코드&quot;를 추가했습니다.
   ...
   사용 [!DNL Embed Code] 기능을 사용하면 선택한 에셋 유형에 대한 뷰어 코드를 검토할 수 있습니다. 또한 뷰어 배포를 위해 코드를 클립보드로 복사하여 웹 페이지에 붙여넣을 수도 있습니다. 코드 편집은 [임베드 코드] 대화 상자에서 허용되지 않습니다. .

   다음 [!DNL Embed Code] 기능은 를 열 때 사용할 수 있습니다 [!DNL Preview: Viewer List] 페이지 또는 [!DNL URLs] 패널 위치 [!DNL Detail View] 다음 자산 유형의 경우:
...
* 이제 메타데이터 설정이 관리 사용자 인터페이스에 그룹화되었습니다.
   ...
   위치 **[!UICONTROL 설정 > 응용 프로그램 설정]**, 이제 메타데이터 관련 설정 페이지가 이라는 최상위 섹션으로 그룹화되었습니다. [!DNL Metadata]. 여기에서 메타데이터 보기, 메타데이터 사전 설정, 메타데이터 스키마 및 사용자 정의 필드에 대한 설정 페이지를 찾을 수 있습니다.
