...
## 5.8.2 버그 수정 {#section-50e7ea1e01dd4e1fa9c8b3e00eb002b4}

* 사용자가 마우스를 사용하여 페이지를 넘길 수 없는 경우 `frametransition=turn`.
...
* 수정자의 값 `native` 은 `playback` 더 이상 사용되지 않습니다. 새 값을 대신 `progressive` 사용하십시오.

* 비디오용 HTTPS 스트리밍 재생에 대한 지원을 [!DNL Dynamic Media] 추가했습니다.
...
## 5.8.1 버그 수정 {#section-867d7f16480f43d5ac0f6e3e4d77ad80}

* 사용자가 키보드 탭 방식으로 비디오 컨트롤에 집중할 수 없었습니다.
...
* 플라이아웃 뷰어 - Internet Explorer 9는 마우스를 놓은 후 화면상에 표시되는 경우가 있습니다.
