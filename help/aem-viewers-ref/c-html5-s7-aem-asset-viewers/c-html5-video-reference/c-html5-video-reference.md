...
위의 모든 단계는 고정 크기 임베딩과 동일합니다. 기존 &quot; 소유자&quot; `DIV` 에 컨테이너를 `DIV`추가합니다. 다음 코드는 전체 예입니다. 브라우저 크기를 조정할 때 뷰어 크기가 어떻게 변경되는지, 그리고 뷰어 종횡비가 자산과 어떻게 일치하는지 볼 수 있습니다.
