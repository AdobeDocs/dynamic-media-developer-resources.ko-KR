...
<table id="table_E314540D347D47699C04EB80D20C0721"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><span class="codeph"> 0 </span>(으)로 설정된 경우 구성 요소는 크기 조정 중 새 이미지를 로드하지 않고 플라이아웃 보기의 이미지 해상도가 변경되지 않습니다. </p> <p><span class="codeph"> 1 </span>(으)로 설정하면 기본 보기에 로드한 이미지에 대해 하나 이상의 너비 중단점을 지정할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
