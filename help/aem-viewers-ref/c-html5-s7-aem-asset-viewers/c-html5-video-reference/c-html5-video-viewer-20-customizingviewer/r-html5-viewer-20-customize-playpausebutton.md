...
>
>속성 선택기 `replay='true'` 비디오가 종료에 도달하고 단추를 선택하면 재생이 처음부터 다시 시작됩니다.
...
32 x 32픽셀이며 컨트롤 막대의 위쪽 및 왼쪽 가장자리에서 6픽셀을 위치하는 재생/일시 중지 단추를 설정하려면 다음을 수행하십시오. 마지막으로, 선택 여부에 따라 4개의 서로 다른 단추 상태에 대해 다른 이미지를 표시합니다.
