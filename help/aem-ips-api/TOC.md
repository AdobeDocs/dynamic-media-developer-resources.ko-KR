...
+ 작업 방법 {#operation-methods}
   + [작업 방법](operations/c-operations-intro/c-operations-intro.md)
   + 작업 매개 변수 {#operation-parameters}
      ...
      + [batch 파섹](operations/c-operations-intro/c-methods/r-batch-get-asset-publish-contexts.md)
      ...
      + [set 파섹](operations/c-operations-intro/c-methods/r-set-image-rendering-publish-settings.md)
      + [set 파섹](operations/c-operations-intro/c-methods/r-set-image-serving-publish-settings.md)
...
+ 데이터 유형 {#data-types}
   ...
   + [ColorManagement옵션](types/c-data-types/r-color-management-options.md)
   ...
   + [회사 회원](types/c-data-types/r-company-membership.md)
   ...
   + [ExcludeMozillaArray](types/c-data-types/r-exclude-byproduct-array.md)
   + [ExcludeMozillaCondition](types/c-data-types/r-exclude-byproduct-condition.md)
   ...
   + [Illustrator옵션](types/c-data-types/r-illustrator-options.md)
   ...
   + [메타데이터삭제](types/c-data-types/r-metadata-delete.md)
   ...
   + [메타데이터업데이트](types/c-data-types/r-metadata-update.md)
   ...
   + [PDFptions](types/c-data-types/r-pdf-options.md)
   ...
   + [RipPdfs작업](types/c-data-types/r-rip-pdfs-job.md)
   + [RTFInfo](types/c-data-types/r-rtf-info.md)
   + [예약작업](types/c-data-types/r-scheduled-job.md)
   ...
   + [작업 항목 진행](types/c-data-types/r-task-item-progress.md)
   ...
   + [축소판 옵션](types/c-data-types/r-thumbnail-options.md)
   ...
   + [UploadUrl작업](types/c-data-types/r-upload-urls-job.md)
...
+ 변경 로그 {#change-log}
   ...
   + Version 6.0 {#version-6-0}
      ...
      + [작업:새로 만들기 및 수정됨](change-log/c-change-log/c-6/r-6-operations.md)
      + [데이터 유형:새로 만들기 및 수정됨](change-log/c-change-log/c-6/r-6-types.md)
   + Version 4.5 {#version-4-5}
      + [버전 4.5](change-log/c-change-log/c-4-5/c-4-5.md)
      + [작업:새로 만들기 및 수정됨](change-log/c-change-log/c-4-5/r-4-5-operations.md)
      + [데이터 유형:새로 만들기 및 수정됨](change-log/c-change-log/c-4-5/r-4-5-types.md)
      + [제한된 사용](change-log/c-change-log/c-4-5/r-restricted-use.md)
   + Version 4.4 {#version-4-4}
      + [버전 4.4](change-log/c-change-log/c-4-4/c-4-4.md)
      + [작업:새로 만들기 및 수정됨](change-log/c-change-log/c-4-4/r-4-4-operations.md)
      + [데이터 유형:새로 만들기 및 수정됨](change-log/c-change-log/c-4-4/r-4-4-types.md)
      + [문자열 상수:새로 만들기 및 수정됨](change-log/c-change-log/c-4-4/r-4-4-string-constants.md)
   + Version 4.2 {#version-4-2}
      + [버전 4.2](change-log/c-change-log/c-4-2/c-4-2.md)
      + [데이터 유형:새로 만들기 및 수정됨](change-log/c-change-log/c-4-2/r-4-2-types.md)
   ...
   + Version 3.8 {#version-3-8}
      ...
      + [작업:새로 만들기 및 수정됨](change-log/c-change-log/c-3-8/r-3-8-operations.md)
      + [데이터 유형:새로 만들기 및 수정됨](change-log/c-change-log/c-3-8/r-3-8-types.md)
      + [문자열 상수:새로 만들기 및 수정됨](change-log/c-change-log/c-3-8/r-3-8-string-constants.md)
   + Version 3.7 {#version-3-7}
      + [버전 3.7](change-log/c-change-log/c-3-7/c-3-7.md)
      + [작업:새로 만들기 및 수정됨](change-log/c-change-log/c-3-7/r-3-7-operations.md)
      + [데이터 유형:새로 만들기 및 수정됨](change-log/c-change-log/c-3-7/r-3-7-types.md)
      + [문자열 상수:새로 만들기 및 수정됨](change-log/c-change-log/c-3-7/r-3-7-string-constants.md)
