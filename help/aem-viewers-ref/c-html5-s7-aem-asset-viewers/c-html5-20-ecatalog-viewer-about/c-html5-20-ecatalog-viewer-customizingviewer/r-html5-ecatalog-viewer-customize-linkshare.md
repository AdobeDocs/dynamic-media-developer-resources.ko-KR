...
예 - 패딩, 22 x 12픽셀 아이콘, 굵은 16포인트 제목, 28 x 28픽셀 닫기 버튼 등을 사용하여 대화 상자 컨테이너 위쪽에서 2픽셀, 오른쪽에서 2픽셀을 지정하는 대화 상자 헤더를 설정하려면 다음을 수행합니다.
...
예 - 포함 코드 텍스트 주위에 1픽셀 회색 테두리를 설정하고 패딩이 9픽셀인 경우:
