...
<table id="table_441553CD34C94A58A9D7CBF772DEDDB6"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 구성 요소 영역 내 썸네일 컨테이너의 내부 수평 정렬(또는 앵커 설정)을 지정합니다. </p> <p>콜 투 액션에서 내부 썸네일 컨테이너는 전체 썸네일 수만 표시되도록 크기가 조정됩니다. 그 결과 내부 컨테이너와 외부 구성 요소 경계 간에 패딩이 있습니다. </p> <p>이 수정자는 내부 썸네일 컨테이너가 구성 요소 내부에 수평으로 배치되는 방식을 지정합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
