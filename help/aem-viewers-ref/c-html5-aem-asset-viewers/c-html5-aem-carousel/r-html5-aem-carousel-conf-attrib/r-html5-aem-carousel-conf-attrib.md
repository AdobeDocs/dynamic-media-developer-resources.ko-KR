---
description: 회전판 뷰어에 대한 구성 특성 설명서입니다.
seo-description: 회전판 뷰어에 대한 구성 특성 설명서입니다.
...
* `cont_carouselView.fmt` (구성 요소 ID로 적음, 컨테이너 요소의 ID `cont` 라고 가정하는 경우)
