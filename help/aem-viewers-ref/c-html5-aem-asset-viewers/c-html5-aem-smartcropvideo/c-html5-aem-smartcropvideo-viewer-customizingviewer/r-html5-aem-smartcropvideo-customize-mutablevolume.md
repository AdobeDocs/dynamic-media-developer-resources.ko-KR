---
title: 가변 볼륨
description: 가변 볼륨 컨트롤은 처음에 스마트 자르기 비디오 플레이어 사운드를 음소거하거나 음소거를 해제할 수 있는 단추로 나타납니다.
...
가변 볼륨 컨트롤은 처음에 스마트 자르기 비디오 플레이어 사운드를 음소거하거나 음소거를 해제할 수 있는 단추로 나타납니다.
...
위의 코드 예제에서 볼륨 수준은 `0` 다음에 있음 `mutableVolume` 구성 요소. 그러면 동일한 구성 요소가 비활성화되므로 최종 사용자는 해당 구성 요소를 사용할 수 없습니다.
