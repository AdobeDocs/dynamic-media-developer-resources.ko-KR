...
SDK API를 사용하여 작업할 때는 [뷰어 SDK 네임스페이스](../../../c-html5-aem-asset-viewers/c-html5-aem-carousel/c-html5-aem-carousel-namespace.md)에 설명된 대로 올바른 정규화된 SDK 네임스페이스를 사용해야 합니다.
