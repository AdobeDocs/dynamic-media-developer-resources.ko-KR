...
<table id="simpletable_432EC5501CA3431B83A762C3EE4E8DD2"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>재질 카탈로그 ID(<span class="codeph"> 특성::RootId</span>와 일치). </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="varname"> recId</span> </p></td> 
  <td class="stentry"> <p>비네팅 ID(<span class="codeph"> 비네팅::Id</span>과(와) 일치함). </p></td> 
 </tr> 
 <tr class="strow"> 
...
`vignette=`은(는) 요청 URL 경로에서 비네팅을 지정하는 대신 사용할 수 있습니다. 템플릿의 변수를 통해 비네팅을 지정하는 데 사용됩니다.
