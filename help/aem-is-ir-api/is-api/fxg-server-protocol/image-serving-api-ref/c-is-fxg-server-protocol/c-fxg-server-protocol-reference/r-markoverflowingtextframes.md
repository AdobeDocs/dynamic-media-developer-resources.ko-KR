---
description: 더하기 기호가 있는 넘치는 텍스트 프레임을 표시합니다. 텍스트 오버플로 표시기는 텍스트가 텍스트 프레임(또는 스레드된 텍스트의 경우 마지막 텍스트 프레임)에서 할당된 공간을 초과하는 경우를 보여 줍니다. 이 표시기는 위에 더하기 기호가 있는 빨간색 상자입니다.
...
더하기 기호가 있는 넘치는 텍스트 프레임을 표시합니다. 텍스트 오버플로 표시기는 텍스트가 텍스트 프레임(또는 스레드된 텍스트의 경우 마지막 텍스트 프레임)에서 할당된 공간을 초과하는 경우를 보여 줍니다. 이 표시기는 위에 더하기 기호가 있는 빨간색 상자입니다.
