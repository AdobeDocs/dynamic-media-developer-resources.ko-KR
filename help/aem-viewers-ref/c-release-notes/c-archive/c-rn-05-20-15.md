...
**중요 사항:** 이제 최신 버전의 Firefox에서는 기본적으로 웹 사이트에서 Adobe Flash 플러그인이 실행되지 않습니다. 데스크탑 시스템에서 Adobe Flash 플러그인을 사용하는 Scene7 비디오 플레이어를 배포한 경우 다음과 같은 세 가지 옵션이 있습니다.

* 사용자는 Firefox에서 보고 있는 웹 페이지 맨 위에 나타나는 메시지를 볼 수 있습니다. 프롬프트에서 플러그인을 계속 차단하거나 플러그인을 실행하도록 선택할 수 있습니다. 이 경우 비디오가 평소대로 재생됩니다.
* 비디오 플레이어를 로 설정합니다. `playback=native` 모드. 이렇게 하면 MP4 비디오가 점진적으로 재생됩니다.

   자세한 내용은 [VideoPlayer.playback](../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/c-html5-video-cmdref/r-html5-video-viewer-conf-attrib-videoplayer-playback.md#reference-13ec45db4cd4443b842f310153623221).
