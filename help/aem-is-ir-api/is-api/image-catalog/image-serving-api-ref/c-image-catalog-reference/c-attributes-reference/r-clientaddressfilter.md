...
지정한 경우 목록에 없는 IP 주소의 클라이언트에서 온 이 이미지 카탈로그에 대한 요청이 거부됩니다.
...
<table id="simpletable_9F82BB0D42A9434883F2F70A2A92898C"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>ddd.ddd.ddd.ddd <span class="varname"> 형식의 IP</span> 주소. </p></td> 
 </tr> 
 <tr class="strow"> 
...
192.168.12.0에서 192.168.13.255 사이의 주소가 있는 512 호스트에 액세스 권한 부여: `192.168.12.0/23`
