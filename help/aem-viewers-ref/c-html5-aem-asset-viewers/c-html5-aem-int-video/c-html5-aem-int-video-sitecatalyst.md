---
description: HTML5 Video360 뷰어는 즉시 사용 가능한 Adobe Analytics 추적을 지원합니다.
seo-description: HTML5 Video360 뷰어는 즉시 사용 가능한 Adobe Analytics 추적을 지원합니다.
...
HTML5 Video360 뷰어는 즉시 사용 가능한 Adobe Analytics 추적을 지원합니다.
...
<table id="table_5D090E6614974D968E1A93B5727D859C"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>뷰어를 먼저 로드할 때 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> SWAP </span> </p> </td> 
   <td colname="col2"> <p>setAsset() API를 사용하여 뷰어에서 자산을 <span class="codeph"> 교환하는 </span> 경우 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> PLAY </span> </p> </td> 
   <td colname="col2"> <p>재생 시작 시 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> PAUSE </span> </p> </td> 
   <td colname="col2"> <p>재생이 일시 정지되는 경우 </p> </td> 
  </tr> 
  <tr> 
