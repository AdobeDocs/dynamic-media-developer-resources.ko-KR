...
`searchAssets` 작업에 `excludeByproducts` 필터 플래그를 추가했습니다. 이 플래그를 true로 설정하면 `PSDlayer`개의 이미지가 실행되고 PDF에서 리핑된 이미지가 실행됩니다.
...
<table id="table_DCCE936B797A448598C30E3B344525A5"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>® .doc으로 끝나는 파일용 Word 문서. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> ExcelDoc </span> </p> </td> 
   <td colname="col2"> <p>.xls로 끝나는 파일용 ® Excel 문서. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> PowerPointDoc </span> </p> </td> 
   <td colname="col2"> <p>® .ppt로 끝나는 파일용 PowerPoint 문서. </p> </td> 
  </tr> 
  <tr> 
