...
웹 도메인 이름을 쉼표로 구분한 목록을 포함하는 문자열입니다. 비어 있는 경우 의 이미지 속성에 액세스할 수 있으려면 이미지 렌더링과 동일한 도메인에서 응용 프로그램을 제공해야 합니다 [!DNL swf]형식이 지정된 응답.

## 기본값 {#section-8fae0c896f7d46e7a61b0fd7e2b34dc3}

상속됨 `default::TrustedDomains` 없는 경우
