---
description: 축소판의 세로 정렬 wid= 및 hei= 또는 DefaultThumbPix 속성으로 지정된 응답 이미지 사각형의 축소판 이미지의 세로 정렬을 지정합니다.
seo-description: 축소판의 세로 정렬 wid= 및 hei= 또는 DefaultThumbPix 속성으로 지정된 응답 이미지 사각형의 축소판 이미지의 세로 정렬을 지정합니다.
