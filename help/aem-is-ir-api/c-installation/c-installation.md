...
* 플랫폼 서버. 독립형 Java™ 웹 애플리케이션 및 애플리케이션 서버입니다.

이미지 렌더링은 이러한 두 서버 구성 요소의 일부입니다.

다음 지침에 따라 `install_root` 는 이미지 제공 및 이미지 렌더링 이 설치된 루트 폴더를 나타냅니다. 및 `server:port` 는 Platform Server의 기본 수신 포트로 구성된 호스트 이름 또는 IP 주소 및 포트 번호를 나타냅니다.
