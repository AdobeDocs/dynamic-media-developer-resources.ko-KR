...
다음은 재생 중에 사운드가 비활성화되도록 비디오 플레이어를 사용자 정의하는 방법의 예입니다. 뷰어의 포함 코드에 다음 코드를 추가합니다.
...
위의 코드 예에서 볼륨 수준은 구성 `0` 요소에 대해 설정됩니다 `mutableVolume` . 그런 다음 동일한 구성 요소가 비활성화되어 최종 사용자가 사용할 수 없습니다.
