...
seo-description: 플라이아웃 뷰어는 즉시 사용 가능한 Adobe Analytics 추적을 지원합니다.
...
인라인 확대/축소 뷰어는 즉시 사용 가능한 [!DNL Adobe Analytics] 추적을 지원합니다. 추적을 활성화하려면 적절한 회사 사전 설정 이름을 `config2` 매개 변수로 전달합니다.
