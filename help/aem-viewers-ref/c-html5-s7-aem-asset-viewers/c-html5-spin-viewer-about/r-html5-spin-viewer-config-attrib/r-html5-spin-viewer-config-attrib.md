---
description: 스핀 뷰어에 대한 구성 속성 설명서를 참조하십시오.
seo-description: 스핀 뷰어에 대한 구성 속성 설명서를 참조하십시오.
...
* `cont_spinView.zoomstep` (구성 요소 ID로 적음, 컨테이너 요소의 ID `cont` 라고 가정하는 경우)
