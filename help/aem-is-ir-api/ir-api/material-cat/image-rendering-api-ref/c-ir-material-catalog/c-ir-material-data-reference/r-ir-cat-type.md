---
description: 자료 유형. 재료의 서피스 유형. 카탈로그 광택 및 카탈로그 거칠기와 함께 사용하여 3D 반사 렌더링 효과를 제어합니다.
...
자료 유형. 재료의 서피스 유형. 3D 반사 렌더링 효과를 제어하기 위해 catalog::Gloss 및 catalog::Roughness와 함께 사용됩니다.

## 속성 {#section-86e8bc194f764c848e0ee55630a5ac1b}

열거형. 모든 자재에 선택 사항입니다. 비네팅에 3D 반사 렌더링 기능이 없는 경우 무시됩니다.

<table id="simpletable_85BF61871CAA420B92B855AAB8FACA2C"> 
 <tr class="strow"> 
  <td class="stentry"> <p>0 </p> </td> 
  <td class="stentry"> <p>알 수 없음, 서버에서 기본값을 사용합니다. </p> </td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>얇은 천입니다. </p> </td> 
 </tr> 
 <tr class="strow"> 
