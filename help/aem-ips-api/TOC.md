...
+ [Dynamic Media 이미지 제작 시스템 API 정보](c-overview.md)
...
+ 작업 방법 {#operation-methods}
   ...
   + 작업 매개 변수 {#operation-parameters}
      ...
      + [cdnCacheInvalidate](operations/c-operations-intro/c-methods/r-cdn-cache-invalidation.md)
...
+ 데이터 유형 {#data-types}
   ...
   + [KnokicBackgroundOptions](types/c-data-types/r-knockout-background-options.md)
   ...
   + [메타데이터 업데이트](types/c-data-types/r-metadata-update.md)
   ...
   + [권한 업데이트](types/c-data-types/r-permission-update.md)
   + [PermissionUpdateArray](types/c-data-types/r-permission-update-array.md)
   + [원근감](types/c-data-types/r-perspective-quad.md)
   ...
   + [RipPdfs 작업](types/c-data-types/r-rip-pdfs-job.md)
...
+ 결함 {#faults}
   + [결함 개요](faults/c-faults/c-faults.md)
