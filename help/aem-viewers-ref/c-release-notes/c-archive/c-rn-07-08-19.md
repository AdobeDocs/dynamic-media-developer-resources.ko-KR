...
* Adobe Launch와의 통합에 대한 지원이 추가되었습니다 [!DNL Dynamic Media] 뷰어 확장.
* Video360Viewer용 Oculus Browser에서 VR 작업 모드에 대한 지원을 추가했습니다.
* 추가됨 `RolloverKeyEvent.HREF_ACTIVATED` 클라이언트 코드가 eCatalogViewer 및 eCatalogSearchViewer의 이미지 맵 활성화에 응답할 수 있도록 허용하는 이벤트.
