...
SDK API를 사용하는 경우 Viewer SDK에 설명된 대로 올바르게 정규화된 SDK 네임스페이스를 사용해야 [합니다](../../../c-html5-s7-aem-asset-viewers/c-html5-spin-viewer-about/c-html5-spin-viewer-namespace.md#concept-fa293878c9ff4758ae888415c70fbeef).
